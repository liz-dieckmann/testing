    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-3 gap-8 max-w-4xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-lg shadow-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "input", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-lg shadow-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "button", className: "inline-flex items-center px-4 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 transition-colors", children: "View Button Demo" }, "button")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-6 rounded-lg shadow-md", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "datepicker", className: "inline-flex items-center px-4 py-2 bg-purple-600 text-white rounded-md hover:bg-purple-700 transition-colors", children: "View Datepicker Demo" }, "datepicker")
        ] })
      ] })
    ] }) })
  ] });
