...
import { E as Ea, P as Pa, $ as $n, z as za, u as na, Q as Qo, T as Ta, w as Ha, G as Ge, O as Oa, L as La, B as Ba, x as Ga, A as Aa, y as xr, v as vr, d as br, S as Sr, e as ea, C as ta } from "./createLucideIcon-CJLbBnZK.js";
import { L as minimalExpenseValidationStrategy, N as useBaseExpenseForm, F as FormSectionType, b as useReceiptCheckboxEffects, O as useFormButtonStateSync, P as useFormImperativeHandle, Q as FormSectionProvider, R as FormRenderer, T as affidavitExpenseValidationStrategy } from "./SupportingFilesFormSection-CCSbXKNX.js";
import { s as sortFormSections } from "./form-factory-CgtUgesN.js";
...
import { C as Controller, e as useWatch } from "./zod-D1zX7vJS.js";
import { V as VENDOR_OPTIONS, E as EXPENSE_LOCATION_OPTIONS } from "./form-options-BKSnsJQ4.js";
import { R as ReceiptSection } from "./ReceiptSection-Dlcdm-n0.js";
import { F as FileText } from "./file-text-BTnaJqUB.js";
function AffidavitSection({
  control,
  disabled = false
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(za, { className: "min-h-0 h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex-1 flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: "w-full max-h-full bg-yellow-50 border border-yellow-200 p-3 flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full overflow-y-auto", children: [
...
function ExpenseFormDialog({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ta, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ha, { asChild: true, children: trigger || /* @__PURE__ */ jsxRuntimeExports.jsx(Ge, { children: "New Expense" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Oa, { className: dialogClassName, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(La, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ba, { children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ga, { children: description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FormComponent,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Aa, { className: "gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Ge,
          {
            type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(xr, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { children: [
          ...
          draftButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Sr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: draftButtonState.tooltip }) })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(xr, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(br, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Ge,
          ...
          submitButtonState.tooltip && /* @__PURE__ */ jsxRuntimeExports.jsx(Sr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: submitButtonState.tooltip }) })
        ] }) })
      ] })
    ] })
  ] });
...
function MinimalDetailsSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(za, { className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Controller,
        {
          name: "vendor",
...
function FormsTestingPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Pa, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Pa, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(za, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            MinimalExpenseDialog,
            {
              trigger: /* @__PURE__ */ jsxRuntimeExports.jsx(Ge, { className: "w-full", children: "Open Minimal Expense Form" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(za, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ...
            {
              trigger: /* @__PURE__ */ jsxRuntimeExports.jsx(Ge, { className: "w-full", children: "Open Affidavit Expense Form" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pa, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Last Submitted" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(za, { children: lastSubmitted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Pa, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold", children: "Last Draft" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(za, { children: lastDraft ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Pa, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-semibold", children: "Code Reusability Demonstration" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(za, { className: "prose prose-sm max-w-none", children: [
