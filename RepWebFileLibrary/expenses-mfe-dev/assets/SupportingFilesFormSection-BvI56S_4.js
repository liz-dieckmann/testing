...
import { s as string, o as object, b as boolean, g as custom, a as array, h as date, c as unknown, n as number, d as useForm, e as a, f as useWatch, i as useFormState, C as Controller } from "./zod-D5pnVYPu.js";
...
import { L as LoadingSpinner, P as Plus } from "./LoadingSpinner-BqLZLzEJ.js";
...
const ConfirmDialog = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ta, { open, onOpenChange, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Oa, { className: "max-w-md", children: [
...
const { useCallback: useCallback$4, useEffect: useEffect$2, useRef: useRef$2, useState: useState$3 } = React$3;
const ReceiptUpload = ({
  onReceiptChange,
  onUploadingChange,
  initialReceipt,
  ...
  if (section.hideHeader) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      ConditionalSection,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: "gap-0 flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx(za, { className: "p-0", children: section.render(finalProps) }) }) }, section.id)
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ConditionalSection,
    {
      ...
      behavior,
      onDisabledChange: handleDisabledChange,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-section-id": section.id, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { children: [
...
const AllocationTypeChips = memo$2(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: allocationTypes.map((allocationType) => /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(br, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      gr,
      {
        disabled,
...
const { useCallback: useCallback$1, useEffect, useRef, useState } = React;
...
function FileCard({
  ...
  if (isUploading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
  ...
  if (hasError) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { className: "bg-red-50 px-2 py-2 w-full flex justify-between flex-row items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center flex-1 min-w-0 gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { delayDuration: FILE_NAME_POPOVER_DELAY, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(br, { className: "min-w-0 text-left flex flex-nowrap items-center", children: fileName(file.originalName) }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: "bg-white hover:bg-trax-neutral-20 px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
...
function SupportingFiles({
  ...
  const handleFileChange = useCallback$1(async (e) => {
    ...
    if (totalFiles > maxFiles) {
      ...
      if (filesToAdd <= 0) {
        ls.error(`Maximum ${maxFiles} supporting file${maxFiles > 1 ? "s" : ""} allowed`, {
          duration: 3e3
        });
        return;
      }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Pa, { className: `flex items-center flex-col w-full h-fit overflow-clip ${className}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row w-full items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center w-full ml-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { delayDuration: 120, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(br, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(GrCircleInformation, { className: "text-gray-500 hover:cursor-pointer select-none" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Sr, { variant: "default", side: "top", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-trax-blue-700 text-white border-none text-sm p-2 w-64", children: displayTooltip }) })
      ] }) }),
      ...
      ) : !hideAddButtonWhenFull ? /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { delayDuration: 120, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(br, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleAddSupportingDocumentClick, disabled: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(FaPlus, { className: "opacity-20 hover:cursor-not-allowed" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Sr,
          {
            variant: "light",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: `bg-white w-full p-0 ${state.attachments.length === 0 && !state.isUploading ? "h-0" : "h-auto"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col my-1 mx-2 gap-1", children: [
      ...
      state.isUploading && state.uploadingFileIndex !== void 0 && state.uploadingFileIndex >= state.attachments.length && /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: "bg-white px-2 py-2 w-full flex justify-between flex-row items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingSpinner, { className: "size-4" }),
