...
var use = React$1c[" use ".trim().toString()];
...
function createSlot$6(ownerName) {
  ...
  const Slot2 = React$1c.forwardRef((props, forwardedRef) => {
    let { children, ...slotProps } = props;
    if (isLazyComponent(children) && typeof use === "function") {
      children = use(children._payload);
    }
    const childrenArray = React$1c.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable$6);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React$1c.Children.count(newElement) > 1) return React$1c.Children.only(null);
          return React$1c.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React$1c.isValidElement(newElement) ? React$1c.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function createSlotClone$6(ownerName) {
  const SlotClone = React$1c.forwardRef((props, forwardedRef) => {
    let { children, ...slotProps } = props;
    if (isLazyComponent(children) && typeof use === "function") {
      children = use(children._payload);
    }
    if (React$1c.isValidElement(children)) {
      const childrenRef = getElementRef$7(children);
      const props2 = mergeProps$6(slotProps, children.props);
      if (children.type !== React$1c.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React$1c.cloneElement(children, props2);
    }
    return React$1c.Children.count(children) > 1 ? React$1c.Children.only(null) : null;
  });
...
function isSlottable$6(child) {
  return React$1c.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$7;
}
...
var Primitive$2 = NODES$2.reduce((primitive, node) => {
  ...
  const Node2 = React$1b.forwardRef((props, forwardedRef) => {
...
var NAME$3 = "Label";
var Label$2 = React$1a.forwardRef((props, forwardedRef) => {
...
var useLayoutEffect2 = (globalThis == null ? void 0 : globalThis.document) ? React$18.useLayoutEffect : () => {
};
...
function useSize(element) {
  const [size2, setSize] = React$15.useState(void 0);
  useLayoutEffect2(() => {
    if (element) {
...
function createSlot$5(ownerName) {
  ...
  const Slot2 = React$13.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React$13.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable$5);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React$13.Children.count(newElement) > 1) return React$13.Children.only(null);
          return React$13.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React$13.isValidElement(newElement) ? React$13.cloneElement(newElement, void 0, newChildren) : null });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot2.displayName = `${ownerName}.Slot`;
...
function createSlotClone$5(ownerName) {
  const SlotClone = React$13.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React$13.isValidElement(children)) {
      const childrenRef = getElementRef$5(children);
      const props2 = mergeProps$5(slotProps, children.props);
      if (children.type !== React$13.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React$13.cloneElement(children, props2);
    }
    return React$13.Children.count(children) > 1 ? React$13.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable$5(child) {
  return React$13.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$6;
}
...
var Primitive$1 = NODES$1.reduce((primitive, node) => {
  ...
  const Node2 = React$12.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot2 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React$11.useState(null);
  const [bubbleInput, setBubbleInput] = React$11.useState(null);
  const hasConsumerStoppedPropagationRef = React$11.useRef(false);
...
var CheckboxTrigger = React$11.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React$11.useRef(checked);
    React$11.useEffect(() => {
...
var Checkbox = React$11.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCheckbox,
      name,
...
var CheckboxIndicator = React$11.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React$11.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React$11.useRef(isIndeterminate$1(checked) ? false : checked);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Primitive$1.input,
      {
        type: "checkbox",
...
var DismissableLayerContext = React$Z.createContext({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var DismissableLayer = React$Z.forwardRef(
  (props, forwardedRef) => {
    const {
...
var DismissableLayerBranch = React$Z.forwardRef((props, forwardedRef) => {
  const context = React$Z.useContext(DismissableLayerContext);
...
var Portal$5 = React$X.forwardRef((props, forwardedRef) => {
  var _a;
...
var useIsomorphicLayoutEffect = typeof window !== "undefined" ? React$V.useLayoutEffect : React$V.useEffect;
...
var SideCar$1 = function(_a) {
  ...
  return React$U.createElement(Target, __assign({}, rest));
};
...
var RemoveScroll = React$T.forwardRef(function(props, parentRef) {
  var ref = React$T.useRef(null);
  var _a = React$T.useState({
  ...
  return React$T.createElement(
    React$T.Fragment,
    null,
    enabled && React$T.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
    forwardProps ? React$T.cloneElement(React$T.Children.only(children), __assign(__assign({}, containerProps), { ref: containerRef })) : React$T.createElement(Container, __assign({}, containerProps, { className, ref: containerRef }), children)
  );
});
...
var RemoveScrollBar = function(_a) {
  ...
  useLockAttribute();
  var gap = React$R.useMemo(function() {
    return getGapWidth(gapMode);
  }, [gapMode]);
  return React$R.createElement(Style, { styles: getStyles(gap, !noRelative, gapMode, !noImportant ? "!important" : "") });
};
...
function RemoveScrollSideCar(props) {
  var shouldPreventQueue = React$Q.useRef([]);
  var touchStartRef = React$Q.useRef([0, 0]);
  var activeAxis = React$Q.useRef();
  var id = React$Q.useState(idCounter++)[0];
  var Style2 = React$Q.useState(styleSingleton)[0];
  var lastProps = React$Q.useRef(props);
  ...
  var shouldCancelEvent = React$Q.useCallback(function(event, parent) {
  ...
  var shouldPrevent = React$Q.useCallback(function(_event) {
    var event = _event;
  ...
  var shouldCancel = React$Q.useCallback(function(name, delta, target, should) {
  ...
  var scrollTouchStart = React$Q.useCallback(function(event) {
    touchStartRef.current = getTouchXY(event);
    activeAxis.current = void 0;
  }, []);
  var scrollWheel = React$Q.useCallback(function(event) {
    shouldCancel(event.type, getDeltaXY(event), event.target, shouldCancelEvent(event, props.lockRef.current));
  }, []);
  var scrollTouchMove = React$Q.useCallback(function(event) {
  ...
  return React$Q.createElement(
    React$Q.Fragment,
    null,
    inert ? React$Q.createElement(Style2, { styles: generateStyle(id) }) : null,
    removeScrollBar ? React$Q.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null
  );
}
...
var ReactRemoveScroll = React$P.forwardRef(function(props, ref) {
  return React$P.createElement(RemoveScroll, __assign({}, props, { ref, sideCar: SideCar }));
});
...
function createSlot$4(ownerName) {
  ...
  const Slot2 = React$O.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenArray = React$O.Children.toArray(children);
    const slottable = childrenArray.find(isSlottable$4);
    if (slottable) {
      const newElement = slottable.props.children;
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React$O.Children.count(newElement) > 1) return React$O.Children.only(null);
          return React$O.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React$O.isValidElement(newElement) ? React$O.cloneElement(newElement, void 0, newChildren) : null });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot2.displayName = `${ownerName}.Slot`;
...
function createSlotClone$4(ownerName) {
  const SlotClone = React$O.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React$O.isValidElement(children)) {
      const childrenRef = getElementRef$4(children);
      const props2 = mergeProps$4(slotProps, children.props);
      if (children.type !== React$O.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React$O.cloneElement(children, props2);
    }
    return React$O.Children.count(children) > 1 ? React$O.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable$4(child) {
  return React$O.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$5;
}
...
var DialogTrigger = React$N.forwardRef(
  (props, forwardedRef) => {
...
var DialogPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PortalProvider$3, { scope: __scopeDialog, forceMount, children: React$N.Children.map(children, (child) => /* @__PURE__ */ jsxRuntimeExports.jsx(Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$5, { asChild: true, container, children: child }) })) });
};
DialogPortal.displayName = PORTAL_NAME$5;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React$N.forwardRef(
  (props, forwardedRef) => {
...
var DialogContent = React$N.forwardRef(
  (props, forwardedRef) => {
...
var DialogTitle = React$N.forwardRef(
  (props, forwardedRef) => {
...
var DialogDescription = React$N.forwardRef(
  (props, forwardedRef) => {
...
var DialogClose = React$N.forwardRef(
  (props, forwardedRef) => {
...
function isSlottable$3(child) {
  return React$M.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$4;
}
...
function useLatestRef(value) {
  const ref = React$J.useRef(value);
  index(() => {
    ref.current = value;
  });
  return ref;
...
function useFloating(options) {
  ...
  const [data, setData] = React$J.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  const [latestMiddleware, setLatestMiddleware] = React$J.useState(middleware);
  if (!deepEqual(latestMiddleware, middleware)) {
    setLatestMiddleware(middleware);
  }
  const [_reference, _setReference] = React$J.useState(null);
  const [_floating, _setFloating] = React$J.useState(null);
  const setReference = React$J.useCallback((node) => {
    if (node !== referenceRef.current) {
      referenceRef.current = node;
      _setReference(node);
    }
  }, []);
  const setFloating = React$J.useCallback((node) => {
  ...
  const referenceRef = React$J.useRef(null);
  const floatingRef = React$J.useRef(null);
  const dataRef = React$J.useRef(data);
  const hasWhileElementsMounted = whileElementsMounted != null;
  const whileElementsMountedRef = useLatestRef(whileElementsMounted);
  const platformRef = useLatestRef(platform2);
  const openRef = useLatestRef(open);
  const update = React$J.useCallback(() => {
  ...
  const isMountedRef = React$J.useRef(false);
  index(() => {
  ...
  const refs = React$J.useMemo(() => ({
    reference: referenceRef,
    floating: floatingRef,
    setReference,
    setFloating
  }), [setReference, setFloating]);
  const elements = React$J.useMemo(() => ({
    reference: referenceEl,
    floating: floatingEl
  }), [referenceEl, floatingEl]);
  const floatingStyles = React$J.useMemo(() => {
    const initialStyles = {
      position: strategy,
      left: 0,
      top: 0
...
var NAME$2 = "Arrow";
var Arrow$1 = React$I.forwardRef((props, forwardedRef) => {
...
var PopperContent = React$H.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow$12, setArrow] = React$H.useState(null);
...
var PopperArrow = React$H.forwardRef(function PopperArrow2(props, forwardedRef) {
...
var RovingFocusGroup = React$G.forwardRef(
  (props, forwardedRef) => {
...
var RovingFocusGroupImpl = React$G.forwardRef((props, forwardedRef) => {
  const {
  ...
  const [isTabbingBackOut, setIsTabbingBackOut] = React$G.useState(false);
  const handleEntryFocus = useCallbackRef$1(onEntryFocus);
  const getItems = useCollection$2(__scopeRovingFocusGroup);
  const isClickFocusRef = React$G.useRef(false);
  const [focusableItemsCount, setFocusableItemsCount] = React$G.useState(0);
  React$G.useEffect(() => {
    const node = ref.current;
    if (node) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    RovingFocusProvider,
    {
      ...
      loop,
      currentTabStopId,
      onItemFocus: React$G.useCallback(
        (tabStopId) => setCurrentTabStopId(tabStopId),
        [setCurrentTabStopId]
      ),
      onItemShiftTab: React$G.useCallback(() => setIsTabbingBackOut(true), []),
      onFocusableItemAdd: React$G.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount + 1),
        []
      ),
      onFocusableItemRemove: React$G.useCallback(
        () => setFocusableItemsCount((prevCount) => prevCount - 1),
        []
      ),
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
...
var RovingFocusGroupItem = React$G.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRovingFocusGroup,
      focusable = true,
...
function createSlot$2(ownerName) {
  ...
  const Slot2 = React$F.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    ...
    if (slottable) {
      ...
      const newChildren = childrenArray.map((child) => {
        if (child === slottable) {
          if (React$F.Children.count(newElement) > 1) return React$F.Children.only(null);
          return React$F.isValidElement(newElement) ? newElement.props.children : null;
        } else {
          return child;
        }
      });
      return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children: React$F.isValidElement(newElement) ? React$F.cloneElement(newElement, void 0, newChildren) : null });
    }
    return /* @__PURE__ */ jsxRuntimeExports.jsx(SlotClone, { ...slotProps, ref: forwardedRef, children });
  });
  Slot2.displayName = `${ownerName}.Slot`;
...
function createSlotClone$2(ownerName) {
  const SlotClone = React$F.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    if (React$F.isValidElement(children)) {
      const childrenRef = getElementRef$2(children);
      const props2 = mergeProps$2(slotProps, children.props);
      if (children.type !== React$F.Fragment) {
        props2.ref = forwardedRef ? composeRefs(forwardedRef, childrenRef) : childrenRef;
      }
      return React$F.cloneElement(children, props2);
    }
    return React$F.Children.count(children) > 1 ? React$F.Children.only(null) : null;
  });
  SlotClone.displayName = `${ownerName}.SlotClone`;
  return SlotClone;
}
...
function isSlottable$2(child) {
  return React$F.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$3;
}
...
var Menu = (props) => {
  ...
  const isUsingKeyboardRef = React$E.useRef(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root2$3, { ...popperScope, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    MenuProvider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        {
          scope: __scopeMenu,
          onClose: React$E.useCallback(() => handleOpenChange(false), [handleOpenChange]),
          isUsingKeyboardRef,
          dir: direction,
          modal,
          children
...
var MenuAnchor = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuContent = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuRootContentModal = React$E.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(CONTENT_NAME$5, props.__scopeMenu);
...
var MenuRootContentNonModal = React$E.forwardRef((props, forwardedRef) => {
  const context = useMenuContext(CONTENT_NAME$5, props.__scopeMenu);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    MenuContentImpl,
    {
...
var MenuContentImpl = React$E.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeMenu,
      loop = false,
    ...
    const [currentItemId, setCurrentItemId] = React$E.useState(null);
    const contentRef = React$E.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef, context.onContentChange);
    const timerRef = React$E.useRef(0);
    const searchRef = React$E.useRef("");
    const pointerGraceTimerRef = React$E.useRef(0);
    const pointerGraceIntentRef = React$E.useRef(null);
    const pointerDirRef = React$E.useRef("right");
    const lastPointerXRef = React$E.useRef(0);
    const ScrollLockWrapper = disableOutsideScroll ? ReactRemoveScroll : React$E.Fragment;
    ...
    useFocusGuards();
    const isPointerMovingToSubmenu = React$E.useCallback((event) => {
      var _a, _b;
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      MenuContentProvider,
      {
        scope: __scopeMenu,
        searchRef,
        onItemEnter: React$E.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ),
        onItemLeave: React$E.useCallback(
          (event) => {
            var _a;
        ...
        onTriggerLeave: React$E.useCallback(
          (event) => {
            if (isPointerMovingToSubmenu(event)) event.preventDefault();
          },
          [isPointerMovingToSubmenu]
        ...
        onPointerGraceIntentChange: React$E.useCallback((intent) => {
...
var MenuGroup = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuLabel = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuItem = React$E.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = useComposedRefs(forwardedRef, ref);
    const isPointerDownRef = React$E.useRef(false);
    const handleSelect = () => {
...
var MenuItemImpl = React$E.forwardRef(
  (props, forwardedRef) => {
    ...
    const ref = React$E.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, ref);
    const [isFocused, setIsFocused] = React$E.useState(false);
    const [textContent, setTextContent] = React$E.useState("");
    React$E.useEffect(() => {
      const menuItem = ref.current;
      if (menuItem) {
...
var MenuCheckboxItem = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioGroup = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuRadioItem = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuItemIndicator = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuSeparator = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuArrow = React$E.forwardRef(
  (props, forwardedRef) => {
...
var MenuSubTrigger = React$E.forwardRef(
  (props, forwardedRef) => {
    const context = useMenuContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const rootContext = useMenuRootContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const subContext = useMenuSubContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const contentContext = useMenuContentContext(SUB_TRIGGER_NAME$1, props.__scopeMenu);
    const openTimerRef = React$E.useRef(null);
    const { pointerGraceTimerRef, onPointerGraceIntentChange } = contentContext;
    const scope = { __scopeMenu: props.__scopeMenu };
    const clearOpenTimer = React$E.useCallback(() => {
      if (openTimerRef.current) window.clearTimeout(openTimerRef.current);
      openTimerRef.current = null;
    }, []);
    React$E.useEffect(() => clearOpenTimer, [clearOpenTimer]);
    React$E.useEffect(() => {
...
var MenuSubContent = React$E.forwardRef(
  (props, forwardedRef) => {
    const portalContext = usePortalContext$2(CONTENT_NAME$5, props.__scopeMenu);
...
var DropdownMenuTrigger = React$D.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuContent = React$D.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuGroup = React$D.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuLabel = React$D.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuItem = React$D.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuCheckboxItem = React$D.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioGroup = React$D.forwardRef((props, forwardedRef) => {
...
var DropdownMenuRadioItem = React$D.forwardRef((props, forwardedRef) => {
...
var DropdownMenuItemIndicator = React$D.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSeparator = React$D.forwardRef((props, forwardedRef) => {
...
var DropdownMenuArrow = React$D.forwardRef(
  (props, forwardedRef) => {
...
var DropdownMenuSubTrigger = React$D.forwardRef((props, forwardedRef) => {
...
var DropdownMenuSubContent = React$D.forwardRef((props, forwardedRef) => {
...
function isSlottable$1(child) {
  return React$C.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$2;
}
...
var VisuallyHidden = React$B.forwardRef(
  (props, forwardedRef) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Primitive$1.span,
      {
...
var Select$1 = (props) => {
  ...
  const triggerPointerDownPosRef = React$A.useRef(null);
  const isFormControl = trigger ? form || !!trigger.closest("form") : true;
  const [nativeOptionsSet, setNativeOptionsSet] = React$A.useState(/* @__PURE__ */ new Set());
...
var SelectTrigger = React$A.forwardRef(
  (props, forwardedRef) => {
    ...
    const pointerTypeRef = React$A.useRef("touch");
...
var SelectValue = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectIcon = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectContent = React$A.forwardRef(
  (props, forwardedRef) => {
    const context = useSelectContext(CONTENT_NAME$3, props.__scopeSelect);
    const [fragment, setFragment] = React$A.useState();
    useLayoutEffect2(() => {
...
var SelectContentImpl = React$A.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
    ...
    const [selectedItemText, setSelectedItemText] = React$A.useState(
      null
    );
    const getItems = useCollection(__scopeSelect);
    const [isPositioned, setIsPositioned] = React$A.useState(false);
    const firstValidItemFoundRef = React$A.useRef(false);
    React$A.useEffect(() => {
      if (content) return hideOthers(content);
    }, [content]);
    useFocusGuards();
    const focusFirst2 = React$A.useCallback(
      (candidates) => {
    ...
    const focusSelectedItem = React$A.useCallback(
    ...
    const itemRefCallback = React$A.useCallback(
      (node, value, disabled) => {
    ...
    const handleItemLeave = React$A.useCallback(() => content == null ? void 0 : content.focus(), [content]);
    const itemTextRefCallback = React$A.useCallback(
      (node, value, disabled) => {
        const isFirstValidItem = !firstValidItemFoundRef.current && !disabled;
        const isSelectedItem = context.value !== void 0 && context.value === value;
        if (isSelectedItem || isFirstValidItem) {
...
var SelectItemAlignedPosition = React$A.forwardRef((props, forwardedRef) => {
  ...
  const handleScrollButtonChange = React$A.useCallback(
    (node) => {
...
var SelectPopperPosition = React$A.forwardRef((props, forwardedRef) => {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectGroup = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectLabel = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectItem = React$A.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSelect,
      value,
    ...
    const [textValue, setTextValue] = React$A.useState(textValueProp ?? "");
...
var SelectItemText = React$A.forwardRef(
  (props, forwardedRef) => {
    ...
    const nativeOption = React$A.useMemo(
...
var SelectItemIndicator = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectScrollUpButton = React$A.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_UP_BUTTON_NAME, props.__scopeSelect);
  const [canScrollUp, setCanScrollUp] = React$A.useState(false);
...
var SelectScrollDownButton = React$A.forwardRef((props, forwardedRef) => {
  const contentContext = useSelectContentContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const viewportContext = useSelectViewportContext(SCROLL_DOWN_BUTTON_NAME, props.__scopeSelect);
  const [canScrollDown, setCanScrollDown] = React$A.useState(false);
  const composedRefs = useComposedRefs(forwardedRef, viewportContext.onScrollButtonChange);
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      let handleScroll2 = function() {
...
var SelectScrollButtonImpl = React$A.forwardRef((props, forwardedRef) => {
...
var SelectSeparator = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectArrow = React$A.forwardRef(
  (props, forwardedRef) => {
...
var SelectBubbleInput = React$A.forwardRef(
...
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React$A.useCallback(
    (key) => {
      const search = searchRef.current + key;
...
function isSlottable(child) {
  return React$z.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER$1;
}
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React$y.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Root2$3, { ...popperScope, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React$y.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React$y.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React$y.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React$y.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContent = React$y.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React$y.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME$2, props.__scopePopover);
    const contentRef = React$y.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React$y.useRef(false);
    React$y.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
...
var PopoverContentNonModal = React$y.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME$2, props.__scopePopover);
    const hasInteractedOutsideRef = React$y.useRef(false);
    const hasPointerDownOutsideRef = React$y.useRef(false);
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      PopoverContentImpl,
      {
        ...props,
...
var PopoverContentImpl = React$y.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React$y.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React$y.forwardRef(
  (props, forwardedRef) => {
...
function Button(props) {
  return React$x.createElement("button", { ...props });
}
const React$w = await importShared("react");
function CaptionLabel(props) {
  return React$w.createElement("span", { ...props });
}
const React$v = await importShared("react");
function Chevron(props) {
  ...
  return (
    ...
    React$v.createElement(
      "svg",
      { className, width: size2, height: size2, viewBox: "0 0 24 24" },
      orientation === "up" && React$v.createElement("polygon", { points: "6.77 17 12.5 11.43 18.24 17 20 15.28 12.5 8 5 15.28" }),
      orientation === "down" && React$v.createElement("polygon", { points: "6.77 8 12.5 13.57 18.24 8 20 9.72 12.5 17 5 9.72" }),
      orientation === "left" && React$v.createElement("polygon", { points: "16 18.112 9.81111111 12 16 5.87733333 14.0888889 4 6 12 14.0888889 20" }),
      orientation === "right" && React$v.createElement("polygon", { points: "8 18.112 14.18888889 12 8 5.87733333 9.91111111 4 18 12 9.91111111 20" })
    )
  );
}
const React$u = await importShared("react");
function Day(props) {
  ...
  return React$u.createElement("td", { ...tdProps });
}
const React$t = await importShared("react");
function DayButton(props) {
  ...
  return React$t.createElement("button", { ref, ...buttonProps });
}
var UI;
(function(UI2) {
  UI2["Root"] = "root";
...
function Dropdown(props) {
  ...
  return React$s.createElement(
    ...
    React$s.createElement(components2.Select, { className: cssClassSelect, ...selectProps }, options == null ? void 0 : options.map(({ value, label, disabled }) => React$s.createElement(components2.Option, { key: value, value, disabled }, label))),
    React$s.createElement(
      ...
      React$s.createElement(components2.Chevron, { orientation: "down", size: 18, className: classNames[UI.Chevron] })
    )
  );
}
const React$r = await importShared("react");
...
function Month(props) {
  ...
  return React$p.createElement("div", { ...divProps }, props.children);
}
const React$o = await importShared("react");
function MonthCaption(props) {
  const { calendarMonth, displayIndex, ...divProps } = props;
  return React$o.createElement("div", { ...divProps });
}
const React$n = await importShared("react");
function MonthGrid(props) {
  return React$n.createElement("table", { ...props });
}
const React$m = await importShared("react");
function Months(props) {
  return React$m.createElement("div", { ...props });
}
...
function MonthsDropdown(props) {
  ...
  return React$l.createElement(components2.Dropdown, { ...props });
}
const React$k = await importShared("react");
const { useCallback: useCallback$1 } = React$k;
function Nav(props) {
  ...
  return React$k.createElement(
    ...
    React$k.createElement(
      ...
      React$k.createElement(components2.Chevron, { disabled: previousMonth ? void 0 : true, className: classNames[UI.Chevron], orientation: "left" })
    ),
    React$k.createElement(
      ...
      React$k.createElement(components2.Chevron, { disabled: nextMonth ? void 0 : true, orientation: "right", className: classNames[UI.Chevron] })
    )
  );
}
const React$j = await importShared("react");
function NextMonthButton(props) {
  const { components: components2 } = useDayPicker();
  return React$j.createElement(components2.Button, { ...props });
}
const React$i = await importShared("react");
function Option(props) {
  return React$i.createElement("option", { ...props });
}
const React$h = await importShared("react");
...
function Root$4(props) {
  ...
  return React$g.createElement("div", { ...rest, ref: rootRef });
}
const React$f = await importShared("react");
function Select(props) {
  return React$f.createElement("select", { ...props });
}
const React$e = await importShared("react");
function Week(props) {
  const { week, ...trProps } = props;
  return React$e.createElement("tr", { ...trProps });
}
const React$d = await importShared("react");
function Weekday(props) {
  return React$d.createElement("th", { ...props });
}
const React$c = await importShared("react");
function Weekdays(props) {
  return React$c.createElement(
    "thead",
    { "aria-hidden": true },
    React$c.createElement("tr", { ...props })
  );
}
const React$b = await importShared("react");
function WeekNumber(props) {
  const { week, ...thProps } = props;
  return React$b.createElement("th", { ...thProps });
}
const React$a = await importShared("react");
...
function Weeks(props) {
  return React$9.createElement("tbody", { ...props });
}
const React$8 = await importShared("react");
function YearsDropdown(props) {
  const { components: components2 } = useDayPicker();
  return React$8.createElement(components2.Dropdown, { ...props });
}
...
const { useCallback, useMemo, useRef } = React$7;
  ...
  return React$7.createElement(
    ...
    React$7.createElement(
      ...
      React$7.createElement(
        ...
        !props.hideNavigation && !navLayout && React$7.createElement(components2.Nav, { "data-animated-nav": props.animate ? "true" : void 0, className: classNames[UI.Nav], style: styles == null ? void 0 : styles[UI.Nav], "aria-label": labelNav2(), onPreviousClick: handlePreviousClick, onNextClick: handleNextClick, previousMonth, nextMonth }),
        months.map((calendarMonth, displayIndex) => {
          return React$7.createElement(
            ...
            navLayout === "around" && !props.hideNavigation && displayIndex === 0 && React$7.createElement(
              components2.PreviousMonthButton,
            ...
            React$7.createElement(components2.MonthCaption, { "data-animated-caption": props.animate ? "true" : void 0, className: classNames[UI.MonthCaption], style: styles == null ? void 0 : styles[UI.MonthCaption], calendarMonth, displayIndex }, (captionLayout == null ? void 0 : captionLayout.startsWith("dropdown")) ? React$7.createElement(
              ...
              React$7.createElement(components2.CaptionLabel, { className: classNames[UI.CaptionLabel], role: "status", "aria-live": "polite" }, formatCaption2(calendarMonth.date, dateLib.options, dateLib))
            )),
            navLayout === "around" && !props.hideNavigation && displayIndex === numberOfMonths - 1 && React$7.createElement(
              components2.NextMonthButton,
              { type: "button", className: classNames[UI.NextMonthButton], tabIndex: nextMonth ? void 0 : -1, "aria-disabled": nextMonth ? void 0 : true, "aria-label": labelNext2(nextMonth), onClick: handleNextClick, "data-animated-button": props.animate ? "true" : void 0 },
              React$7.createElement(components2.Chevron, { disabled: nextMonth ? void 0 : true, className: classNames[UI.Chevron], orientation: props.dir === "rtl" ? "left" : "right" })
            ),
            displayIndex === numberOfMonths - 1 && navLayout === "after" && !props.hideNavigation && React$7.createElement(components2.Nav, { "data-animated-nav": props.animate ? "true" : void 0, className: classNames[UI.Nav], style: styles == null ? void 0 : styles[UI.Nav], "aria-label": labelNav2(), onPreviousClick: handlePreviousClick, onNextClick: handleNextClick, previousMonth, nextMonth }),
            React$7.createElement(
              ...
              !props.hideWeekdays && React$7.createElement(
                ...
                showWeekNumber && React$7.createElement(components2.WeekNumberHeader, { "aria-label": labelWeekNumberHeader2(dateLib.options), className: classNames[UI.WeekNumberHeader], style: styles == null ? void 0 : styles[UI.WeekNumberHeader], scope: "col" }, formatWeekNumberHeader2()),
                weekdays.map((weekday) => React$7.createElement(components2.Weekday, { "aria-label": labelWeekday2(weekday, dateLib.options, dateLib), className: classNames[UI.Weekday], key: String(weekday), style: styles == null ? void 0 : styles[UI.Weekday], scope: "col" }, formatWeekdayName2(weekday, dateLib.options, dateLib)))
              ),
              React$7.createElement(components2.Weeks, { "data-animated-weeks": props.animate ? "true" : void 0, className: classNames[UI.Weeks], style: styles == null ? void 0 : styles[UI.Weeks] }, calendarMonth.weeks.map((week) => {
                return React$7.createElement(
                  components2.Week,
                  ...
                  React$7.createElement(components2.WeekNumber, { week, style: styles == null ? void 0 : styles[UI.WeekNumber], "aria-label": labelWeekNumber2(week.weekNumber, {
                    locale
                  ...
                  week.days.map((day) => {
                    ...
                    return (
                      ...
                      React$7.createElement(components2.Day, { key: `${dateLib.format(date, "yyyy-MM-dd")}_${dateLib.format(day.displayMonth, "yyyy-MM")}`, day, modifiers, className: className2.join(" "), style: style2, role: "gridcell", "aria-selected": modifiers.selected || void 0, "aria-label": ariaLabel, "data-day": dateLib.format(date, "yyyy-MM-dd"), "data-month": day.outside ? dateLib.format(date, "yyyy-MM") : void 0, "data-selected": modifiers.selected || void 0, "data-disabled": modifiers.disabled || void 0, "data-hidden": modifiers.hidden || void 0, "data-outside": day.outside || void 0, "data-focused": modifiers.focused || void 0, "data-today": modifiers.today || void 0 }, !modifiers.hidden && isInteractive ? React$7.createElement(components2.DayButton, { className: classNames[UI.DayButton], style: styles == null ? void 0 : styles[UI.DayButton], type: "button", day, modifiers, disabled: modifiers.disabled || void 0, tabIndex: isFocusTarget(day) ? 0 : -1, "aria-label": labelDayButton2(date, modifiers, dateLib.options, dateLib), onClick: handleDayClick(day, modifiers), onBlur: handleDayBlur(day, modifiers), onFocus: handleDayFocus(day, modifiers), onKeyDown: handleDayKeyDown(day, modifiers), onMouseEnter: handleDayMouseEnter(day, modifiers), onMouseLeave: handleDayMouseLeave(day, modifiers) }, formatDay2(date, dateLib.options, dateLib)) : !modifiers.hidden && formatDay2(day.date, dateLib.options, dateLib))
                    );
                  })
                );
              }))
      ...
      React$7.createElement(components2.Footer, { className: classNames[UI.Footer], style: styles == null ? void 0 : styles[UI.Footer], role: "status", "aria-live": "polite" }, props.footer)
    )
  );
}
...
function createContextScope(scopeName, createContextScopeDeps = []) {
  let defaultContexts = [];
  function createContext3(rootComponentName, defaultContext) {
    const BaseContext = React$6.createContext(defaultContext);
    ...
    const Provider2 = (props) => {
      ...
      const { scope, children, ...context } = props;
      const Context = ((_a = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a[index2]) || BaseContext;
      const value = React$6.useMemo(() => context, Object.values(context));
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Context.Provider, { value, children });
    };
    Provider2.displayName = rootComponentName + "Provider";
    function useContext2(consumerName, scope) {
      var _a;
      const Context = ((_a = scope == null ? void 0 : scope[scopeName]) == null ? void 0 : _a[index2]) || BaseContext;
      const context = React$6.useContext(Context);
      if (context) return context;
      if (defaultContext !== void 0) return defaultContext;
      throw new Error(`\`${consumerName}\` must be used within \`${rootComponentName}\``);
    }
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return React$6.createContext(defaultContext);
    });
    return function useScope(scope) {
      const contexts = (scope == null ? void 0 : scope[scopeName]) || scopeContexts;
...
function composeContextScopes(...scopes) {
  ...
  const createScope = () => {
    ...
    return function useComposedScopes(overrideScopes) {
      ...
      return React$6.useMemo(() => ({ [`__scope${baseScope.scopeName}`]: nextScopes }), [nextScopes]);
    };
  };
  createScope.scopeName = baseScope.scopeName;
  return createScope;
...
var Primitive = NODES.reduce((primitive, node) => {
  const Slot2 = /* @__PURE__ */ createSlot$6(`Primitive.${node}`);
  const Node2 = React$5.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot2 : node;
    if (typeof window !== "undefined") {
      window[Symbol.for("radix-ui")] = true;
...
var Progress = React$4.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeProgress,
...
var ProgressIndicator = React$4.forwardRef(
  (props, forwardedRef) => {
...
var NAME = "Toggle";
var Toggle = React$3.forwardRef((props, forwardedRef) => {
...
var Collapsible = React$2.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeCollapsible,
      open: openProp,
...
var CollapsibleTrigger = React$2.forwardRef(
  (props, forwardedRef) => {
...
var CollapsibleContent = React$2.forwardRef(
  (props, forwardedRef) => {
...
var CollapsibleContentImpl = React$2.forwardRef((props, forwardedRef) => {
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React$1.useRef(true);
...
var Tooltip = (props) => {
  ...
  const openTimerRef = React$1.useRef(0);
  const disableHoverableContent = disableHoverableContentProp ?? providerContext.disableHoverableContent;
  const delayDuration = delayDurationProp ?? providerContext.delayDuration;
  const wasOpenDelayedRef = React$1.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React$1.useMemo(() => {
  ...
  const handleDelayedOpen = React$1.useCallback(() => {
    window.clearTimeout(openTimerRef.current);
    openTimerRef.current = window.setTimeout(() => {
...
var TooltipTrigger = React$1.forwardRef(
  (props, forwardedRef) => {
    ...
    const hasPointerMoveOpenedRef = React$1.useRef(false);
    const handlePointerUp = React$1.useCallback(() => isPointerDownRef.current = false, []);
    React$1.useEffect(() => {
...
var TooltipContentHoverable = React$1.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME, props.__scopeTooltip);
  const ref = React$1.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React$1.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React$1.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React$1.useCallback(
    (event, hoverTarget) => {
...
var TooltipContentImpl = React$1.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
...
var TooltipArrow = React$1.forwardRef(
  (props, forwardedRef) => {
...
const Un = await importShared("react-dom");
const Xn = "trax-ui-component";
function p(...e) {
  return twMerge(clsx(e));
}
function Se(...e) {
  return twMerge(clsx(Xn, e));
}
const _t = cva(
  ...
  ({
    ...
    const c = o ? Slot$4 : "button", g = r2 === "center" || !s && a;
...
), He = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Root$9,
  {
    ref: t,
    className: p(Wn(), e),
...
He.displayName = Root$9.displayName;
...
function La({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Kn, { "data-slot": "dialog-portal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Zn, {}),
...
const pn = Root2$1, hn = Value, Vt = w.forwardRef(({ className: e, children: n, ...t }, r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Trigger$2,
  {
    ref: r2,
    className: p(
...
Vt.displayName = Trigger$2.displayName;
const xn = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ScrollUpButton,
  {
    ref: t,
    className: p(
...
xn.displayName = ScrollUpButton.displayName;
const vn = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  ScrollDownButton,
  {
    ref: t,
    className: p(
...
vn.displayName = ScrollDownButton.displayName;
const zt = w.forwardRef(({ className: e, children: n, position: t = "popper", ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$2, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Content2$2,
  {
    ref: o,
    className: Se(
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(vn, {})
    ]
  }
) }));
zt.displayName = Content2$2.displayName;
const nr = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Label,
  {
    ref: t,
...
nr.displayName = Label.displayName;
const kt = w.forwardRef(({ className: e, children: n, ...t }, r2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Item,
  {
    ref: r2,
    className: p(
...
kt.displayName = Item.displayName;
const rr = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Separator,
  {
    ref: t,
...
rr.displayName = Separator.displayName;
function or({
  ...e
}) {
...
function lr({ className: e, variant: n, ...t }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: p(ir({ variant: n }), e), ...t });
}
function dr({
  className: e,
  classNames: n,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    DayPicker,
    {
      ...
      components: {
        Root: ({ className: c, rootRef: g, ...l }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            "data-slot": "calendar",
            ref: g,
        ...
        Chevron: ({ className: c, orientation: g, ...l }) => g === "left" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: p("size-4", c), ...l }) : g === "right" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChevronRight,
          {
...
function ur({
  ...
  const o = getDefaultClassNames(), a = w.useRef(null);
  return w.useEffect(() => {
    var _a;
...
const Tt = w.forwardRef(({ className: e, indicatorClassName: n, value: t, minWidthOnZero: r2 = false, ...o }, a) => {
...
Tt.displayName = Root$3.displayName;
...
wn.displayName = "Loader";
const cr = cva(
  p(
    "inline-flex items-center justify-center gap-0.5 rounded-lg font-medium leading-[1.4] outline-none transition-all whitespace-nowrap",
    "h-8 px-2 py-1 text-xs",
    "bg-trax-neutral-0 text-trax-neutral-500 border border-trax-neutral-20 [box-shadow:var(--shadow-trax-chip)]",
...
), gr = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Root$2,
  {
    ref: t,
...
function as({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(pr, { asChild: e, ...n });
}
function ss({
  className: e,
  ...n
...
function vr({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(xr, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Root3, { "data-slot": "tooltip", ...e }) });
}
function wr({
  ...e
}) {
...
function Sr({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Content2,
    {
      ...
      sideOffset: o ? -4 : n,
      className: Se(
        br({ variant: s, size: u, className: e }),
        `origin-(--radix-popover-content-transform-origin) animate-slide-out-from-${r2 ? "none" : d.side}`
      ),
      ...d,
      children: [
        t,
        o && /* @__PURE__ */ jsxRuntimeExports.jsx(Arrow2, { className: Se(
          a || yr({ variant: s, className: e })
        ) })
      ]
    }
  ) });
...
const Rr = (e) => {
...
}, _r = Array(12).fill(0), Nr = ({ visible: e, className: n }) => /* @__PURE__ */ v.createElement("div", {
  className: [
...
}, _r.map((t, r2) => /* @__PURE__ */ v.createElement("div", {
  className: "sonner-loading-bar",
  key: `spinner-bar-${r2}`
})))), Fr = /* @__PURE__ */ v.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  height: "20",
  ...
  clipRule: "evenodd"
})), Ir = /* @__PURE__ */ v.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  fill: "currentColor",
  height: "20",
  ...
  clipRule: "evenodd"
})), Er = /* @__PURE__ */ v.createElement("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 20 20",
  fill: "currentColor",
  height: "20",
  ...
  const [e, n] = v.useState(document.hidden);
  return v.useEffect(() => {
    const t = () => {
      n(document.hidden);
    };
...
class $r {
  constructor() {
    this.subscribe = (n) => (this.subscribers.push(n), () => {
      ...
      var t;
      const { message: r2, ...o } = n, a = typeof (n == null ? void 0 : n.id) == "number" || ((t = n.id) == null ? void 0 : t.length) > 0 ? n.id : Nt++, s = this.toasts.find((d) => d.id === a), u = n.dismissible === void 0 ? true : n.dismissible;
      ...
      const u = o.then(async (c) => {
        if (s = [
          ...
          a = false;
          const l = typeof t.error == "function" ? await t.error(`HTTP error! status: ${c.status}`) : t.error, m = typeof t.description == "function" ? await t.description(`HTTP error! status: ${c.status}`) : t.description, x = typeof l == "object" && !v.isValidElement(l) ? l : {
            message: l
          };
          this.create({
            id: r2,
          ...
          a = false;
          const l = typeof t.error == "function" ? await t.error(c) : t.error, m = typeof t.description == "function" ? await t.description(c) : t.description, x = typeof l == "object" && !v.isValidElement(l) ? l : {
            message: l
          };
          this.create({
            id: r2,
          ...
          a = false;
          const l = typeof t.success == "function" ? await t.success(c) : t.success, m = typeof t.description == "function" ? await t.description(c) : t.description, x = typeof l == "object" && !v.isValidElement(l) ? l : {
            message: l
          };
          this.create({
            id: r2,
        ...
        if (s = [
          ...
          a = false;
          const g = typeof t.error == "function" ? await t.error(c) : t.error, l = typeof t.description == "function" ? await t.description(c) : t.description, f = typeof g == "object" && !v.isValidElement(g) ? g : {
            message: g
          };
          this.create({
            id: r2,
      ...
      }), d = () => new Promise((c, g) => u.then(() => s[0] === "reject" ? g(s[1]) : c(s[1])).catch(g));
      ...
      const r2 = (t == null ? void 0 : t.id) || Nt++;
      return this.create({
        jsx: n(r2),
        id: r2,
        ...t
...
const ae = new $r(), Vr = (e, n) => {
  const t = (n == null ? void 0 : n.id) || Nt++;
  return ae.addToast({
    title: e,
    ...n,
    id: t
  }), t;
}, zr = (e) => e && typeof e == "object" && "ok" in e && typeof e.ok == "boolean" && "status" in e && typeof e.status == "number", kr = Vr, Tr = () => ae.toasts, Hr = () => ae.getActiveToasts(), rt = Object.assign(kr, {
  success: ae.success,
  info: ae.info,
  warning: ae.warning,
  error: ae.error,
...
const Lr = 3, Or = "24px", Ar = "16px", Xt = 4e3, Br = 356, Gr = 14, jr = 45, qr = 200;
function ye(...e) {
...
const Yr = (e) => {
  ...
  const { invert: g, toast: l, unstyled: m, interacting: f, setHeights: x, visibleToasts: b, heights: S, index: h, toasts: M, expanded: F, removeToast: $, defaultRichColors: T, closeButton: D, style: O, cancelButtonStyle: H, actionButtonStyle: Y, className: Q = "", descriptionClassName: se = "", duration: Ce, position: B, gap: ie, expandByDefault: U, classNames: N, icons: k, closeButtonAriaLabel: G = "Close toast" } = e, [me, W] = v.useState(null), [ee, ve] = v.useState(null), [E, L] = v.useState(false), [V, j] = v.useState(false), [we, P] = v.useState(false), [K, Re] = v.useState(false), [Ee, Me] = v.useState(false), [We, le] = v.useState(0), [je, Le] = v.useState(0), _e = v.useRef(l.duration || Ce || Xt), qe = v.useRef(null), ge = v.useRef(null), Ke = h === 0, Ze = h + 1 <= b, re2 = l.type, Ne = l.dismissible !== false, Je = l.className || "", gt = l.descriptionClassName || "", Oe = v.useMemo(() => S.findIndex((I) => I.toastId === l.id) || 0, [
    S,
    l.id
  ]), ft = v.useMemo(() => {
    var I;
    return (I = l.closeButton) != null ? I : D;
  }, [
    l.closeButton,
    D
  ]), Ae = v.useMemo(() => l.duration || Ce || Xt, [
    l.duration,
    Ce
  ]), Ve = v.useRef(0), Fe = v.useRef(0), Qe = v.useRef(0), C = v.useRef(null), [z, be] = B.split("-"), oe = v.useMemo(() => S.reduce((I, X2, te) => te >= Oe ? I : I + X2.height, 0), [
    S,
    Oe
  ]), de = Pr(), et = l.invert || g, mt = re2 === "loading";
  Fe.current = v.useMemo(() => Oe * ie + oe, [
    Oe,
    oe
  ]), v.useEffect(() => {
    _e.current = Ae;
    ...
    const I = ge.current;
    if (I) {
      const X2 = I.getBoundingClientRect().height;
      return Le(X2), x((te) => [
        {
          toastId: l.id,
          height: X2,
        ...
        ...te
      ]), () => x((te) => te.filter((ue) => ue.toastId !== l.id));
    }
  }, [
    x,
    l.id
    ...
    if (!E) return;
    const I = ge.current, X2 = I.style.height;
    I.style.height = "auto";
    const te = I.getBoundingClientRect().height;
    I.style.height = X2, Le(te), x((ue) => ue.find((Z) => Z.toastId === l.id) ? ue.map((Z) => Z.toastId === l.id ? {
      ...Z,
      height: te
    } : Z) : [
      {
  ...
  const De = v.useCallback(() => {
    j(true), le(Fe.current), x((I) => I.filter((X2) => X2.toastId !== l.id)), setTimeout(() => {
      $(l);
    }, qr);
  }, [
    l,
  ...
  v.useEffect(() => {
    if (l.promise && re2 === "loading" || l.duration === 1 / 0 || l.type === "loading") return;
    let I;
    return F || f || de ? (() => {
      if (Qe.current < Ve.current) {
        const ue = (/* @__PURE__ */ new Date()).getTime() - Ve.current;
        _e.current = _e.current - ue;
      }
      Qe.current = (/* @__PURE__ */ new Date()).getTime();
    })() : (() => {
      _e.current !== 1 / 0 && (Ve.current = (/* @__PURE__ */ new Date()).getTime(), I = setTimeout(() => {
    ...
    l.delete && (De(), l.onDismiss == null || l.onDismiss.call(l, l));
  }, [
    De,
    l.delete
  ]);
  function $n() {
    var I;
    if (k == null ? void 0 : k.loading) {
      var X2;
      return /* @__PURE__ */ v.createElement("div", {
        className: ye(N == null ? void 0 : N.loader, l == null || (X2 = l.classNames) == null ? void 0 : X2.loader, "sonner-loader"),
        "data-visible": re2 === "loading"
      }, k.loading);
    }
    return /* @__PURE__ */ v.createElement(Nr, {
      className: ye(N == null ? void 0 : N.loader, l == null || (I = l.classNames) == null ? void 0 : I.loader),
      visible: re2 === "loading"
    });
  }
  const Vn = l.icon || (k == null ? void 0 : k[re2]) || Rr(re2);
  var Bt, Gt;
  return /* @__PURE__ */ v.createElement("li", {
    tabIndex: 0,
    ref: ge,
    className: ye(Q, Je, N == null ? void 0 : N.toast, l == null || (n = l.classNames) == null ? void 0 : n.toast, N == null ? void 0 : N.default, N == null ? void 0 : N[re2], l == null || (t = l.classNames) == null ? void 0 : t[re2]),
    "data-sonner-toast": "",
    "data-rich-colors": (Bt = l.richColors) != null ? Bt : T,
    ...
    style: {
      ...
      "--toasts-before": h,
      "--z-index": M.length - h,
      "--offset": `${V ? We : Fe.current}px`,
      "--initial-height": U ? "auto" : `${je}px`,
      ...O,
      ...l.style
    },
    onDragEnd: () => {
      P(false), W(null), C.current = null;
    },
    onPointerDown: (I) => {
      I.button !== 2 && (mt || !Ne || (qe.current = /* @__PURE__ */ new Date(), le(Fe.current), I.target.setPointerCapture(I.pointerId), I.target.tagName !== "BUTTON" && (P(true), C.current = {
        x: I.clientX,
        y: I.clientY
      })));
    },
    onPointerUp: () => {
      ...
      if (K || !Ne) return;
      C.current = null;
      const ue = Number(((I = ge.current) == null ? void 0 : I.style.getPropertyValue("--swipe-amount-x").replace("px", "")) || 0), tt = Number(((X2 = ge.current) == null ? void 0 : X2.style.getPropertyValue("--swipe-amount-y").replace("px", "")) || 0), Z = (/* @__PURE__ */ new Date()).getTime() - ((te = qe.current) == null ? void 0 : te.getTime()), fe = me === "x" ? ue : tt, nt = Math.abs(fe) / Z;
      if (Math.abs(fe) >= jr || nt > 0.11) {
        le(Fe.current), l.onDismiss == null || l.onDismiss.call(l, l), ve(me === "x" ? ue > 0 ? "right" : "left" : tt > 0 ? "down" : "up"), De(), Re(true);
        return;
      } else {
        var pe, he;
        (pe = ge.current) == null || pe.style.setProperty("--swipe-amount-x", "0px"), (he = ge.current) == null || he.style.setProperty("--swipe-amount-y", "0px");
      }
      Me(false), P(false), W(null);
    },
    onPointerMove: (I) => {
      var X2, te, ue;
      if (!C.current || !Ne || ((X2 = window.getSelection()) == null ? void 0 : X2.toString().length) > 0) return;
      const Z = I.clientY - C.current.y, fe = I.clientX - C.current.x;
      var nt;
      const pe = (nt = e.swipeDirections) != null ? nt : Ur(B);
      !me && (Math.abs(fe) > 1 || Math.abs(Z) > 1) && W(Math.abs(fe) > Math.abs(Z) ? "x" : "y");
      let he = {
        x: 0,
        y: 0
      };
      ...
      if (me === "y") {
        if (pe.includes("top") || pe.includes("bottom"))
          if (pe.includes("top") && Z < 0 || pe.includes("bottom") && Z > 0)
            he.y = Z;
          else {
            const ze = Z * jt(Z);
            he.y = Math.abs(ze) < Math.abs(Z) ? ze : Z;
          }
      } else if (me === "x" && (pe.includes("left") || pe.includes("right")))
        if (pe.includes("left") && fe < 0 || pe.includes("right") && fe > 0)
          he.x = fe;
        else {
          const ze = fe * jt(fe);
          he.x = Math.abs(ze) < Math.abs(fe) ? ze : fe;
        }
      (Math.abs(he.x) > 0 || Math.abs(he.y) > 0) && Me(true), (te = ge.current) == null || te.style.setProperty("--swipe-amount-x", `${he.x}px`), (ue = ge.current) == null || ue.style.setProperty("--swipe-amount-y", `${he.y}px`);
    }
  }, ft && !l.jsx && re2 !== "loading" ? /* @__PURE__ */ v.createElement("button", {
    "aria-label": G,
    "data-disabled": mt,
    ...
    className: ye(N == null ? void 0 : N.closeButton, l == null || (r2 = l.classNames) == null ? void 0 : r2.closeButton)
  }, (Gt = k == null ? void 0 : k.close) != null ? Gt : Dr) : null, (re2 || l.icon || l.promise) && l.icon !== null && ((k == null ? void 0 : k[re2]) !== null || l.icon) ? /* @__PURE__ */ v.createElement("div", {
    "data-icon": "",
    className: ye(N == null ? void 0 : N.icon, l == null || (o = l.classNames) == null ? void 0 : o.icon)
  }, l.promise || l.type === "loading" && !l.icon ? l.icon || $n() : null, l.type !== "loading" ? Vn : null) : null, /* @__PURE__ */ v.createElement("div", {
    "data-content": "",
    className: ye(N == null ? void 0 : N.content, l == null || (a = l.classNames) == null ? void 0 : a.content)
  }, /* @__PURE__ */ v.createElement("div", {
    "data-title": "",
    className: ye(N == null ? void 0 : N.title, l == null || (s = l.classNames) == null ? void 0 : s.title)
  }, l.jsx ? l.jsx : typeof l.title == "function" ? l.title() : l.title), l.description ? /* @__PURE__ */ v.createElement("div", {
    "data-description": "",
    className: ye(se, gt, N == null ? void 0 : N.description, l == null || (u = l.classNames) == null ? void 0 : u.description)
  }, typeof l.description == "function" ? l.description() : l.description) : null), /* @__PURE__ */ v.isValidElement(l.cancel) ? l.cancel : l.cancel && ot(l.cancel) ? /* @__PURE__ */ v.createElement("button", {
    "data-button": true,
    "data-cancel": true,
    style: l.cancelButtonStyle || H,
    onClick: (I) => {
      ot(l.cancel) && Ne && (l.cancel.onClick == null || l.cancel.onClick.call(l.cancel, I), De());
    },
    className: ye(N == null ? void 0 : N.cancelButton, l == null || (d = l.classNames) == null ? void 0 : d.cancelButton)
  }, l.cancel.label) : null, /* @__PURE__ */ v.isValidElement(l.action) ? l.action : l.action && ot(l.action) ? /* @__PURE__ */ v.createElement("button", {
    "data-button": true,
    "data-action": true,
    style: l.actionButtonStyle || Y,
    onClick: (I) => {
      ot(l.action) && (l.action.onClick == null || l.action.onClick.call(l.action, I), !I.defaultPrevented && De());
    },
    className: ye(N == null ? void 0 : N.actionButton, l == null || (c = l.classNames) == null ? void 0 : c.actionButton)
  }, l.action.label) : null);
};
function Wt() {
...
function Xr(e, n) {
  ...
  return [
    ...
    const a = o === 1, s = a ? "--mobile-offset" : "--offset", u = a ? Ar : Or;
    function d(c) {
      [
        "top",
        "right",
...
const Wr = /* @__PURE__ */ v.forwardRef(function(n, t) {
  const { id: r2, invert: o, position: a = "bottom-right", hotkey: s = [
    "altKey",
    "KeyT"
  ], expand: u, closeButton: d, className: c, offset: g, mobileOffset: l, theme: m = "light", richColors: f, duration: x, style: b, visibleToasts: S = Lr, toastOptions: h, dir: M = Wt(), gap: F = Gr, icons: $, containerAriaLabel: T = "Notifications" } = n, [D, O] = v.useState([]), H = v.useMemo(() => r2 ? D.filter((E) => E.toasterId === r2) : D.filter((E) => !E.toasterId), [
    D,
    r2
  ]), Y = v.useMemo(() => Array.from(new Set([
    a
  ].concat(H.filter((E) => E.position).map((E) => E.position)))), [
    H,
    a
  ]), [Q, se] = v.useState([]), [Ce, B] = v.useState(false), [ie, U] = v.useState(false), [N, k] = v.useState(m !== "system" ? m : typeof window < "u" && window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"), G = v.useRef(null), me = s.join("+").replace(/Key/g, "").replace(/Digit/g, ""), W = v.useRef(null), ee = v.useRef(false), ve = v.useCallback((E) => {
    O((L) => {
      var V;
      return (V = L.find((j) => j.id === E.id)) != null && V.delete || ae.dismiss(E.id), L.filter(({ id: j }) => j !== E.id);
    });
  }, []);
  return v.useEffect(() => ae.subscribe((E) => {
    if (E.dismiss) {
      requestAnimationFrame(() => {
        O((L) => L.map((V) => V.id === E.id ? {
          ...V,
          delete: true
        } : V));
      });
    ...
    setTimeout(() => {
      Un.flushSync(() => {
        O((L) => {
          const V = L.findIndex((j) => j.id === E.id);
          return V !== -1 ? [
            ...L.slice(0, V),
            {
              ...L[V],
    ...
    if (m === "system" && (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)").matches ? k("dark") : k("light")), typeof window > "u") return;
    const E = window.matchMedia("(prefers-color-scheme: dark)");
    try {
      E.addEventListener("change", ({ matches: L }) => {
        k(L ? "dark" : "light");
      });
    } catch {
    ...
    const E = (L) => {
      var V;
      if (s.every((P) => L[P] || L.code === P)) {
        var we;
        B(true), (we = G.current) == null || we.focus();
      }
      L.code === "Escape" && (document.activeElement === G.current || (V = G.current) != null && V.contains(document.activeElement)) && B(false);
    };
    ...
    if (G.current)
      return () => {
        W.current && (W.current.focus({
          preventScroll: true
        }), W.current = null, ee.current = false);
      };
  }, [
    G.current
  ...
  /* @__PURE__ */ v.createElement("section", {
    ...
    var V;
    const [j, we] = E.split("-");
    return H.length ? /* @__PURE__ */ v.createElement("ol", {
      key: E,
      dir: M === "auto" ? Wt() : M,
      tabIndex: -1,
      ref: G,
      ...
      "data-x-position": we,
      style: {
        "--front-toast-height": `${((V = Q[0]) == null ? void 0 : V.height) || 0}px`,
        "--width": `${Br}px`,
        "--gap": `${F}px`,
        ...b,
        ...Xr(g, l)
      ...
      onBlur: (P) => {
        ee.current && !P.currentTarget.contains(P.relatedTarget) && (ee.current = false, W.current && (W.current.focus({
          preventScroll: true
        }), W.current = null));
      },
      onFocus: (P) => {
        P.target instanceof HTMLElement && P.target.dataset.dismissible === "false" || ee.current || (ee.current = true, W.current = P.relatedTarget);
      },
      onMouseEnter: () => B(true),
      onMouseMove: () => B(true),
      onMouseLeave: () => {
      ...
      onDragEnd: () => B(false),
      onPointerDown: (P) => {
        P.target instanceof HTMLElement && P.target.dataset.dismissible === "false" || U(true);
      },
      onPointerUp: () => U(false)
    }, H.filter((P) => !P.position && L === 0 || P.position === E).map((P, K) => {
      var Re, Ee;
      return /* @__PURE__ */ v.createElement(Yr, {
        key: P.id,
        icons: $,
        index: K,
        toast: P,
        defaultRichColors: f,
        duration: (Re = h == null ? void 0 : h.duration) != null ? Re : x,
        className: h == null ? void 0 : h.className,
        descriptionClassName: h == null ? void 0 : h.descriptionClassName,
        invert: o,
        visibleToasts: S,
        closeButton: (Ee = h == null ? void 0 : h.closeButton) != null ? Ee : d,
        interacting: ie,
        position: E,
        ...
        removeToast: ve,
        toasts: H.filter((Me) => Me.position == P.position),
        heights: Q.filter((Me) => Me.position == P.position),
        setHeights: se,
        expandByDefault: u,
        gap: F,
        expanded: Ce,
...
var bn = {
  ...
  style: void 0,
  attr: void 0
}, Kt = v.createContext && /* @__PURE__ */ v.createContext(bn), Kr = ["attr", "size", "title"];
function Zr(e, n) {
  if (e == null) return {};
  var t = Jr(e, n), r2, o;
...
function dt(e) {
  for (var n = 1; n < arguments.length; n++) {
    ...
    n % 2 ? Zt(Object(t), true).forEach(function(r2) {
      Qr(e, r2, t[r2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : Zt(Object(t)).forEach(function(r2) {
...
function Qr(e, n, t) {
  return n = eo(n), n in e ? Object.defineProperty(e, n, { value: t, enumerable: true, configurable: true, writable: true }) : e[n] = t, e;
}
function eo(e) {
  var n = to(e, "string");
...
function yn(e) {
  return e && e.map((n, t) => /* @__PURE__ */ v.createElement(n.tag, dt({
    key: t
  }, n.attr), yn(n.child)));
}
function Ht(e) {
  return (n) => /* @__PURE__ */ v.createElement(no, lt({
    attr: dt({}, e.attr)
  }, n), yn(e.child));
}
function no(e) {
  var n = (t) => {
    var {
      ...
      size: o,
      title: a
    } = e, s = Zr(e, Kr), u = o || t.size || "1em", d;
    return t.className && (d = t.className), e.className && (d = (d ? d + " " : "") + e.className), /* @__PURE__ */ v.createElement("svg", lt({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
    }, t.attr, r2, s, {
      ...
      width: u,
      xmlns: "http://www.w3.org/2000/svg"
    }), a && /* @__PURE__ */ v.createElement("title", null, a), e.children);
  };
  return Kt !== void 0 ? /* @__PURE__ */ v.createElement(Kt.Consumer, null, (t) => n(t)) : n(bn);
}
function ro(e) {
  return Ht({ attr: { viewBox: "0 0 24 24", fill: "currentColor" }, child: [{ tag: "path", attr: { d: "M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22ZM11 15V17H13V15H11ZM11 7V13H13V7H11Z" }, child: [] }] })(e);
}
function oo(e) {
  return Ht({ attr: { viewBox: "0 0 512 512" }, child: [{ tag: "path", attr: { d: "M256 48C141.1 48 48 141.1 48 256s93.1 208 208 208 208-93.1 208-208S370.9 48 256 48zm106.5 150.5L228.8 332.8h-.1c-1.7 1.7-6.3 5.5-11.6 5.5-3.8 0-8.1-2.1-11.7-5.7l-56-56c-1.6-1.6-1.6-4.1 0-5.7l17.8-17.8c.8-.8 1.8-1.2 2.8-1.2 1 0 2 .4 2.8 1.2l44.4 44.4 122-122.9c.8-.8 1.8-1.2 2.8-1.2 1.1 0 2.1.4 2.8 1.2l17.5 18.1c1.8 1.7 1.8 4.2.2 5.8z" }, child: [] }] })(e);
}
const is = ({ ...e }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Wr,
  {
  ...
  success: (e, n = {}) => {
    rt.custom((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(oo, { className: "h-5 w-5 text-trax-green-500" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: (r2) => {
                r2.stopPropagation(), rt.dismiss(t);
              },
      ...
      duration: n.duration || Jt.duration
    });
  },
  error: (e, n = {}) => {
    rt.custom((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ro, { className: "h-5 w-5 text-trax-red-500" }) }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: (r2) => {
                r2.stopPropagation(), r2.preventDefault(), rt.dismiss(t);
              },
...
function R(e, n, t) {
  ...
  return (a) => {
    ...
    const u = e(a);
    if (!(u.length !== r2.length || u.some((g, l) => r2[l] !== g)))
      return o;
    r2 = u;
    let c;
    if (t.key && t.debug && (c = Date.now()), o = n(...u), t == null || t.onChange == null || t.onChange(o), t.key && t.debug && t != null && t.debug()) {
      const g = Math.round((Date.now() - s) * 100) / 100, l = Math.round((Date.now() - c) * 100) / 100, m = l / 16, f = (x, b) => {
        for (x = String(x); x.length < b; )
          x = " " + x;
        return x;
      };
...
function uo(e, n, t, r2) {
  const o = () => {
    ...
    }), _(e.options, "debugCells"))
  };
  return e._features.forEach((s) => {
    s.createCell == null || s.createCell(a, t, n, e);
  }, {}), a;
}
function co(e, n, t, r2) {
  var o, a;
  const u = {
    ...e._getDefaultColumnDef(),
    ...n
  }, d = u.accessorKey;
  let c = (o = (a = u.id) != null ? a : d ? typeof String.prototype.replaceAll == "function" ? d.replaceAll(".", "_") : d.replace(/\./g, "_") : void 0) != null ? o : typeof u.header == "string" ? u.header : void 0, g;
  if (u.accessorFn ? g = u.accessorFn : d && (d.includes(".") ? g = (m) => {
    let f = m;
    for (const b of d.split(".")) {
      var x;
      f = (x = f) == null ? void 0 : x[b];
    }
    return f;
  } : g = (m) => m[u.accessorKey]), !c)
    throw new Error();
  let l = {
    id: `${String(c)}`,
    accessorFn: g,
    ...
    columnDef: u,
    columns: [],
    getFlatColumns: R(() => [true], () => {
      var m;
      return [l, ...(m = l.columns) == null ? void 0 : m.flatMap((f) => f.getFlatColumns())];
    }, _(e.options, "debugColumns")),
    getLeafColumns: R(() => [e._getOrderColumnsFn()], (m) => {
      var f;
      if ((f = l.columns) != null && f.length) {
        let x = l.columns.flatMap((b) => b.getLeafColumns());
        return m(x);
      }
      return [l];
    }, _(e.options, "debugColumns"))
...
const go = {
  createTable: (e) => {
    e.getHeaderGroups = R(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (n, t, r2, o) => {
      var a, s;
      ...
      return at(n, [...u, ...c, ...d], e);
    }, _(e.options, ne)), e.getCenterHeaderGroups = R(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (n, t, r2, o) => (t = t.filter((a) => !(r2 != null && r2.includes(a.id)) && !(o != null && o.includes(a.id))), at(n, t, e, "center")), _(e.options, ne)), e.getLeftHeaderGroups = R(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left], (n, t, r2) => {
      var o;
      const a = (o = r2 == null ? void 0 : r2.map((s) => t.find((u) => u.id === s)).filter(Boolean)) != null ? o : [];
      return at(n, a, e, "left");
    }, _(e.options, ne)), e.getRightHeaderGroups = R(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.right], (n, t, r2) => {
      var o;
      const a = (o = r2 == null ? void 0 : r2.map((s) => t.find((u) => u.id === s)).filter(Boolean)) != null ? o : [];
      return at(n, a, e, "right");
    }, _(e.options, ne)), e.getFooterGroups = R(() => [e.getHeaderGroups()], (n) => [...n].reverse(), _(e.options, ne)), e.getLeftFooterGroups = R(() => [e.getLeftHeaderGroups()], (n) => [...n].reverse(), _(e.options, ne)), e.getCenterFooterGroups = R(() => [e.getCenterHeaderGroups()], (n) => [...n].reverse(), _(e.options, ne)), e.getRightFooterGroups = R(() => [e.getRightHeaderGroups()], (n) => [...n].reverse(), _(e.options, ne)), e.getFlatHeaders = R(() => [e.getHeaderGroups()], (n) => n.map((t) => t.headers).flat(), _(e.options, ne)), e.getLeftFlatHeaders = R(() => [e.getLeftHeaderGroups()], (n) => n.map((t) => t.headers).flat(), _(e.options, ne)), e.getCenterFlatHeaders = R(() => [e.getCenterHeaderGroups()], (n) => n.map((t) => t.headers).flat(), _(e.options, ne)), e.getRightFlatHeaders = R(() => [e.getRightHeaderGroups()], (n) => n.map((t) => t.headers).flat(), _(e.options, ne)), e.getCenterLeafHeaders = R(() => [e.getCenterFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), _(e.options, ne)), e.getLeftLeafHeaders = R(() => [e.getLeftFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), _(e.options, ne)), e.getRightLeafHeaders = R(() => [e.getRightFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), _(e.options, ne)), e.getLeafHeaders = R(() => [e.getLeftHeaderGroups(), e.getCenterHeaderGroups(), e.getRightHeaderGroups()], (n, t, r2) => {
      var o, a, s, u, d, c;
      return [...(o = (a = n[0]) == null ? void 0 : a.headers) != null ? o : [], ...(s = (u = t[0]) == null ? void 0 : u.headers) != null ? s : [], ...(d = (c = r2[0]) == null ? void 0 : c.headers) != null ? d : []].map((g) => g.getLeafHeaders()).flat();
    }, _(e.options, ne));
  }
};
function at(e, n, t, r2) {
  var o, a;
  let s = 0;
  const u = function(m, f) {
    f === void 0 && (f = 1), s = Math.max(s, f), m.filter((x) => x.getIsVisible()).forEach((x) => {
      var b;
      (b = x.columns) != null && b.length && u(x.columns, f + 1);
    }, 0);
  };
  u(e);
  let d = [];
  const c = (m, f) => {
    ...
    m.forEach((S) => {
      const h = [...b].reverse()[0], M = S.column.depth === x.depth;
      let F, $ = false;
      if (M && S.column.parent ? F = S.column.parent : (F = S.column, $ = true), h && (h == null ? void 0 : h.column) === F)
        h.subHeaders.push(S);
      else {
        const T = nn(t, F, {
          id: [r2, f, F.id, S == null ? void 0 : S.id].filter(Boolean).join("_"),
          isPlaceholder: $,
          placeholderId: $ ? `${b.filter((D) => D.column === F).length}` : void 0,
          depth: f,
          index: b.length
        });
        T.subHeaders.push(S), b.push(T);
      }
      x.headers.push(S), S.headerGroup = x;
    }), d.push(x), f > 0 && c(b, f - 1);
  }, g = n.map((m, f) => nn(t, m, {
    depth: s,
    index: f
  }));
  c(g, s - 1), d.reverse();
  const l = (m) => m.filter((x) => x.column.getIsVisible()).map((x) => {
    let b = 0, S = 0, h = [0];
    x.subHeaders && x.subHeaders.length ? (h = [], l(x.subHeaders).forEach((F) => {
      let {
        colSpan: $,
        rowSpan: T
      } = F;
    ...
    const M = Math.min(...h);
    return S = S + M, x.colSpan = b, x.rowSpan = S, {
      colSpan: b,
      rowSpan: S
    };
  });
...
const fo = (e, n, t, r2, o, a, s) => {
  let u = {
    ...
    subRows: [],
    getLeafRows: () => lo(u.subRows, (d) => d.subRows),
    ...
    getAllCells: R(() => [e.getAllLeafColumns()], (d) => d.map((c) => uo(e, u, c, c.id)), _(e.options, "debugRows")),
    _getAllCellsByColumnId: R(() => [u.getAllCells()], (d) => d.reduce((c, g) => (c[g.column.id] = g, c), {}), _(e.options, "debugRows"))
  };
...
Lt.autoRemove = (e) => xe(e) || xe(e[0]) && xe(e[1]);
const Ie = {
  includesString: Sn,
...
const po = {
  ...
  createColumn: (e, n) => {
    e.getAutoFilterFn = () => {
      ...
      return typeof r2 == "string" ? Ie.includesString : typeof r2 == "number" ? Ie.inNumberRange : typeof r2 == "boolean" || r2 !== null && typeof r2 == "object" ? Ie.equals : Array.isArray(r2) ? Ie.arrIncludes : Ie.weakEquals;
    }, e.getFilterFn = () => {
      var t, r2;
      return ct(e.columnDef.filterFn) ? e.columnDef.filterFn : e.columnDef.filterFn === "auto" ? e.getAutoFilterFn() : (
        // @ts-ignore
        (t = (r2 = n.options.filterFns) == null ? void 0 : r2[e.columnDef.filterFn]) != null ? t : Ie[e.columnDef.filterFn]
      );
    }, e.getCanFilter = () => {
      var t, r2, o;
      ...
      n.setColumnFilters((r2) => {
        const o = e.getFilterFn(), a = r2 == null ? void 0 : r2.find((g) => g.id === e.id), s = Pe(t, a ? a.value : void 0);
        if (rn(o, s, e)) {
          var u;
          return (u = r2 == null ? void 0 : r2.filter((g) => g.id !== e.id)) != null ? u : [];
        }
        const d = {
          id: e.id,
          value: s
        ...
        if (a) {
          var c;
          return (c = r2 == null ? void 0 : r2.map((g) => g.id === e.id ? d : g)) != null ? c : [];
        }
  ...
  createTable: (e) => {
    e.setColumnFilters = (n) => {
      const t = e.getAllLeafColumns(), r2 = (o) => {
        var a;
        return (a = Pe(n, o)) == null ? void 0 : a.filter((s) => {
...
const ho = (e, n, t) => t.reduce((r2, o) => {
...
}, So = (e, n) => Array.from(new Set(n.map((t) => t.getValue(e))).values()), Co = (e, n) => new Set(n.map((t) => t.getValue(e))).size, Ro = (e, n) => n.length, ht = {
  sum: ho,
  min: xo,
  max: vo,
  extent: wo,
  ...
  createColumn: (e, n) => {
    e.toggleGrouping = () => {
      ...
      if (!e)
        throw new Error();
      return ct(e.columnDef.aggregationFn) ? e.columnDef.aggregationFn : e.columnDef.aggregationFn === "auto" ? e.getAutoAggregationFn() : (t = (r2 = n.options.aggregationFns) == null ? void 0 : r2[e.columnDef.aggregationFn]) != null ? t : ht[e.columnDef.aggregationFn];
    };
  },
  createTable: (e) => {
...
const Fo = {
  ...
  createColumn: (e, n) => {
    e.getIndex = R((t) => [Ye(n, t)], (t) => t.findIndex((r2) => r2.id === e.id), _(n.options, "debugColumns")), e.getIsFirstColumn = (t) => {
      var r2;
      return ((r2 = Ye(n, t)[0]) == null ? void 0 : r2.id) === e.id;
    }, e.getIsLastColumn = (t) => {
      var r2;
      const o = Ye(n, t);
  ...
  createTable: (e) => {
    ...
    }, e._getOrderColumnsFn = R(() => [e.getState().columnOrder, e.getState().grouping, e.options.groupedColumnMode], (n, t, r2) => (o) => {
      let a = [];
      if (!(n != null && n.length))
        a = o;
      else {
        ...
        for (; u.length && s.length; ) {
          const d = s.shift(), c = u.findIndex((g) => g.id === d);
          c > -1 && a.push(u.splice(c, 1)[0]);
        }
        a = [...a, ...u];
      }
      return No(a, t, r2);
    }, _(e.options, "debugTable"));
  }
}, xt = () => ({
  left: [],
  right: []
  ...
  createRow: (e, n) => {
    e.getCenterVisibleCells = R(() => [e._getAllVisibleCells(), n.getState().columnPinning.left, n.getState().columnPinning.right], (t, r2, o) => {
      const a = [...r2 ?? [], ...o ?? []];
      return t.filter((s) => !a.includes(s.column.id));
    }, _(n.options, "debugRows")), e.getLeftVisibleCells = R(() => [e._getAllVisibleCells(), n.getState().columnPinning.left], (t, r2) => (r2 ?? []).map((a) => t.find((s) => s.column.id === a)).filter(Boolean).map((a) => ({
      ...a,
      position: "left"
    })), _(n.options, "debugRows")), e.getRightVisibleCells = R(() => [e._getAllVisibleCells(), n.getState().columnPinning.right], (t, r2) => (r2 ?? []).map((a) => t.find((s) => s.column.id === a)).filter(Boolean).map((a) => ({
      ...a,
      position: "right"
    })), _(n.options, "debugRows"));
  },
  createTable: (e) => {
    e.setColumnPinning = (n) => e.options.onColumnPinningChange == null ? void 0 : e.options.onColumnPinningChange(n), e.resetColumnPinning = (n) => {
      var t, r2;
      return e.setColumnPinning(n ? xt() : (t = (r2 = e.initialState) == null ? void 0 : r2.columnPinning) != null ? t : xt());
...
const st = {
  ...
  createColumn: (e, n) => {
    e.getSize = () => {
      ...
      return Math.min(Math.max((t = e.columnDef.minSize) != null ? t : st.minSize, (r2 = a ?? e.columnDef.size) != null ? r2 : st.size), (o = e.columnDef.maxSize) != null ? o : st.maxSize);
    }, e.getStart = R((t) => [t, Ye(n, t), n.getState().columnSizing], (t, r2) => r2.slice(0, e.getIndex(t)).reduce((o, a) => o + a.getSize(), 0), _(n.options, "debugColumns")), e.getAfter = R((t) => [t, Ye(n, t), n.getState().columnSizing], (t, r2) => r2.slice(e.getIndex(t) + 1).reduce((o, a) => o + a.getSize(), 0), _(n.options, "debugColumns")), e.resetSize = () => {
      n.setColumnSizing((t) => {
        let {
          [e.id]: r2,
          ...o
  ...
  createHeader: (e, n) => {
    e.getSize = () => {
      ...
      return (a) => {
        if (!r2 || !o || (a.persist == null || a.persist(), wt(a) && a.touches && a.touches.length > 1))
          return;
        const s = e.getSize(), u = e ? e.getLeafHeaders().map((h) => [h.column.id, h.column.getSize()]) : [[r2.id, r2.getSize()]], d = wt(a) ? Math.round(a.touches[0].clientX) : a.clientX, c = {}, g = (h, M) => {
          typeof M == "number" && (n.setColumnSizingInfo((F) => {
            var $, T;
            const D = n.options.columnResizeDirection === "rtl" ? -1 : 1, O = (M - (($ = F == null ? void 0 : F.startOffset) != null ? $ : 0)) * D, H = Math.max(O / ((T = F == null ? void 0 : F.startSize) != null ? T : 0), -0.999999);
            return F.columnSizingStart.forEach((Y) => {
              let [Q, se] = Y;
              c[Q] = Math.round(Math.max(se + se * H, 0) * 100) / 100;
            }), {
              ...F,
              deltaOffset: O,
              deltaPercentage: H
          ...
          g("end", h), n.setColumnSizingInfo((M) => ({
            ...M,
            isResizingColumn: false,
            startOffset: null,
            startSize: null,
          ...
          moveHandler: (h) => l(h.clientX),
          upHandler: (h) => {
            f == null ? void 0 : f.removeEventListener("mousemove", x.moveHandler), f == null ? void 0 : f.removeEventListener("mouseup", x.upHandler), m(h.clientX);
          }
        }, b = {
          moveHandler: (h) => (h.cancelable && (h.preventDefault(), h.stopPropagation()), l(h.touches[0].clientX), false),
          upHandler: (h) => {
            var M;
            f == null ? void 0 : f.removeEventListener("touchmove", b.moveHandler), f == null ? void 0 : f.removeEventListener("touchend", b.upHandler), h.cancelable && (h.preventDefault(), h.stopPropagation()), m((M = h.touches[0]) == null ? void 0 : M.clientX);
          }
        }, S = Do() ? {
          passive: false
        } : false;
        wt(a) ? (f == null ? void 0 : f.addEventListener("touchmove", b.moveHandler, S), f == null ? void 0 : f.addEventListener("touchend", b.upHandler, S)) : (f == null ? void 0 : f.addEventListener("mousemove", x.moveHandler, S), f == null ? void 0 : f.addEventListener("mouseup", x.upHandler, S)), n.setColumnSizingInfo((h) => ({
          ...h,
          startOffset: d,
          startSize: s,
          deltaOffset: 0,
  ...
  createTable: (e) => {
    e.setColumnSizing = (n) => e.options.onColumnSizingChange == null ? void 0 : e.options.onColumnSizingChange(n), e.setColumnSizingInfo = (n) => e.options.onColumnSizingInfoChange == null ? void 0 : e.options.onColumnSizingInfoChange(n), e.resetColumnSizing = (n) => {
      ...
      var t;
      e.setColumnSizingInfo(n ? vt() : (t = e.initialState.columnSizingInfo) != null ? t : vt());
    }, e.getTotalSize = () => {
      var n, t;
...
const Po = {
  ...
  createRow: (e, n) => {
    e._getAllVisibleCells = R(() => [e.getAllCells(), n.getState().columnVisibility], (t) => t.filter((r2) => r2.column.getIsVisible()), _(n.options, "debugRows")), e.getVisibleCells = R(() => [e.getLeftVisibleCells(), e.getCenterVisibleCells(), e.getRightVisibleCells()], (t, r2, o) => [...t, ...r2, ...o], _(n.options, "debugRows"));
  },
  createTable: (e) => {
    const n = (t, r2) => R(() => [r2(), r2().filter((o) => o.getIsVisible()).map((o) => o.id).join("_")], (o) => o.filter((a) => a.getIsVisible == null ? void 0 : a.getIsVisible()), _(e.options, "debugColumns"));
...
const $o = {
  ...
  createTable: (e) => {
    e.getGlobalAutoFilterFn = () => Ie.includesString, e.getGlobalFilterFn = () => {
      var n, t;
      const {
        globalFilterFn: r2
      } = e.options;
      return ct(r2) ? r2 : r2 === "auto" ? e.getGlobalAutoFilterFn() : (n = (t = e.options.filterFns) == null ? void 0 : t[r2]) != null ? n : Ie[r2];
    }, e.setGlobalFilter = (n) => {
  ...
  getDefaultOptions: (e) => ({
    onPaginationChange: ce("pagination", e)
  }),
  createTable: (e) => {
    let n = false, t = false;
    e._autoResetPageIndex = () => {
      ...
      var o;
      e.setPagination(r2 ? bt() : (o = e.initialState.pagination) != null ? o : bt());
    }, e.setPageIndex = (r2) => {
      e.setPagination((o) => {
        let a = Pe(r2, o.pageIndex);
      ...
      var o, a;
      e.setPageIndex(r2 ? Ft : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageIndex) != null ? o : Ft);
    }, e.resetPageSize = (r2) => {
      var o, a;
      e.setPageSize(r2 ? It : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageSize) != null ? o : It);
    }, e.setPageSize = (r2) => {
      e.setPagination((o) => {
        const a = Math.max(1, Pe(r2, o.pageSize)), s = o.pageSize * o.pageIndex, u = Math.floor(s / a);
        return {
          ...o,
          pageIndex: u,
          pageSize: a
      ...
      var a;
      let s = Pe(r2, (a = e.options.pageCount) != null ? a : -1);
      return typeof s == "number" && (s = Math.max(-1, s)), {
        ...o,
        pageCount: s
      };
    }), e.getPageOptions = R(() => [e.getPageCount()], (r2) => {
      let o = [];
      return r2 && r2 > 0 && (o = [...new Array(r2)].fill(null).map((a, s) => s)), o;
    }, _(e.options, "debugTable")), e.getCanPreviousPage = () => e.getState().pagination.pageIndex > 0, e.getCanNextPage = () => {
      const {
        pageIndex: r2
  ...
  getDefaultOptions: (e) => ({
    onRowPinningChange: ce("rowPinning", e)
  }),
  createRow: (e, n) => {
    e.pin = (t, r2, o) => {
      ...
      n.setRowPinning((d) => {
        ...
        if (t === "top") {
          var f, x;
          return {
            top: [...((f = d == null ? void 0 : d.top) != null ? f : []).filter((b) => !(u != null && u.has(b))), ...Array.from(u)],
            bottom: ((x = d == null ? void 0 : d.bottom) != null ? x : []).filter((b) => !(u != null && u.has(b)))
          };
        }
        return {
          top: ((c = d == null ? void 0 : d.top) != null ? c : []).filter((b) => !(u != null && u.has(b))),
          bottom: ((g = d == null ? void 0 : d.bottom) != null ? g : []).filter((b) => !(u != null && u.has(b)))
        };
      });
    }, e.getCanPin = () => {
      var t;
  ...
  createTable: (e) => {
    e.setRowPinning = (n) => e.options.onRowPinningChange == null ? void 0 : e.options.onRowPinningChange(n), e.resetRowPinning = (n) => {
      var t, r2;
      return e.setRowPinning(n ? yt() : (t = (r2 = e.initialState) == null ? void 0 : r2.rowPinning) != null ? t : yt());
    ...
    }, e.getTopRows = R(() => [e.getRowModel().rows, e.getState().rowPinning.top], (n, t) => e._getPinnedRows(n, t, "top"), _(e.options, "debugRows")), e.getBottomRows = R(() => [e.getRowModel().rows, e.getState().rowPinning.bottom], (n, t) => e._getPinnedRows(n, t, "bottom"), _(e.options, "debugRows")), e.getCenterRows = R(() => [e.getRowModel().rows, e.getState().rowPinning.top, e.getState().rowPinning.bottom], (n, t, r2) => {
      const o = /* @__PURE__ */ new Set([...t ?? [], ...r2 ?? []]);
      return n.filter((a) => !o.has(a.id));
    }, _(e.options, "debugRows"));
  }
}, Ho = {
  getInitialState: (e) => ({
    rowSelection: {},
  ...
  createTable: (e) => {
    ...
    }), e.getPreSelectedRowModel = () => e.getCoreRowModel(), e.getSelectedRowModel = R(() => [e.getState().rowSelection, e.getCoreRowModel()], (n, t) => Object.keys(n).length ? St(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, _(e.options, "debugTable")), e.getFilteredSelectedRowModel = R(() => [e.getState().rowSelection, e.getFilteredRowModel()], (n, t) => Object.keys(n).length ? St(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, _(e.options, "debugTable")), e.getGroupedSelectedRowModel = R(() => [e.getState().rowSelection, e.getSortedRowModel()], (n, t) => Object.keys(n).length ? St(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, _(e.options, "debugTable")), e.getIsAllRowsSelected = () => {
  ...
  createRow: (e, n) => {
    e.toggleSelected = (t, r2) => {
      ...
      n.setRowSelection((a) => {
        ...
        return Et(u, e.id, t, (s = r2 == null ? void 0 : r2.selectChildren) != null ? s : true, n), u;
      });
    }, e.getIsSelected = () => {
      const {
        rowSelection: t
  ...
  t ? (s.getCanMultiSelect() || Object.keys(e).forEach((u) => delete e[u]), s.getCanSelect() && (e[n] = true)) : delete e[n], r2 && (a = s.subRows) != null && a.length && s.getCanSelectSubRows() && s.subRows.forEach((u) => Et(e, u.id, t, r2, o));
};
function St(e, n) {
  const t = e.getState().rowSelection, r2 = [], o = {}, a = function(s, u) {
    return s.map((d) => {
      var c;
      const g = Ot(d, t);
      if (g && (r2.push(d), o[d.id] = d), (c = d.subRows) != null && c.length && (d = {
        ...d,
        subRows: a(d.subRows)
      }), g)
        return d;
...
function Mt(e, n, t) {
  ...
  return e.subRows.forEach((s) => {
    if (!(a && !o) && (s.getCanSelect() && (Ot(s, n) ? a = true : o = false), s.subRows && s.subRows.length)) {
      const u = Mt(s, n);
      u === "all" ? a = true : (u === "some" && (a = true), o = false);
    }
  }), o ? "all" : a ? "some" : false;
}
const Dt = /([0-9]+)/gm, Lo = (e, n, t) => Mn($e(e.getValue(t)).toLowerCase(), $e(n.getValue(t)).toLowerCase()), Oo = (e, n, t) => Mn($e(e.getValue(t)), $e(n.getValue(t))), Ao = (e, n, t) => At($e(e.getValue(t)).toLowerCase(), $e(n.getValue(t)).toLowerCase()), Bo = (e, n, t) => At($e(e.getValue(t)), $e(n.getValue(t))), Go = (e, n, t) => {
  const r2 = e.getValue(t), o = n.getValue(t);
  return r2 > o ? 1 : r2 < o ? -1 : 0;
}, jo = (e, n, t) => At(e.getValue(t), n.getValue(t));
function At(e, n) {
...
function Mn(e, n) {
  const t = e.split(Dt).filter(Boolean), r2 = n.split(Dt).filter(Boolean);
    ...
    e.getAutoSortingFn = () => {
      ...
      for (const o of t) {
        ...
        if (Object.prototype.toString.call(a) === "[object Date]")
          return Ue.datetime;
        if (typeof a == "string" && (r2 = true, a.split(Dt).length > 1))
          return Ue.alphanumeric;
      }
      return r2 ? Ue.text : Ue.basic;
    }, e.getAutoSortDir = () => {
      ...
      if (!e)
        throw new Error();
      return ct(e.columnDef.sortingFn) ? e.columnDef.sortingFn : e.columnDef.sortingFn === "auto" ? e.getAutoSortingFn() : (t = (r2 = n.options.sortingFns) == null ? void 0 : r2[e.columnDef.sortingFn]) != null ? t : Ue[e.columnDef.sortingFn];
    }, e.toggleSorting = (t, r2) => {
      const o = e.getNextSortingOrder(), a = typeof t < "u" && t !== null;
      n.setSorting((s) => {
        const u = s == null ? void 0 : s.find((f) => f.id === e.id), d = s == null ? void 0 : s.findIndex((f) => f.id === e.id);
        let c = [], g, l = a ? t : o === "desc";
        if (s != null && s.length && e.getCanMultiSort() && r2 ? u ? g = "toggle" : g = "add" : s != null && s.length && d !== s.length - 1 ? g = "replace" : u ? g = "toggle" : g = "replace", g === "toggle" && (a || o || (g = "remove")), g === "add") {
          var m;
          c = [...s, {
            id: e.id,
            desc: l
          }], c.splice(0, c.length - ((m = n.options.maxMultiSortColCount) != null ? m : Number.MAX_SAFE_INTEGER));
        } else g === "toggle" ? c = s.map((f) => f.id === e.id ? {
          ...f,
          desc: l
        } : f) : g === "remove" ? c = s.filter((f) => f.id !== e.id) : c = [{
          id: e.id,
          desc: l
        }];
        return c;
...
function Yo(e) {
  var n, t;
  const r2 = [...Uo, ...(n = e._features) != null ? n : []];
  let o = {
    _features: r2
  };
  const a = o._features.reduce((m, f) => Object.assign(m, f.getDefaultOptions == null ? void 0 : f.getDefaultOptions(o)), {}), s = (m) => o.options.mergeOptions ? o.options.mergeOptions(a, m) : {
    ...a,
    ...m
  };
  let d = {
  ...
  o._features.forEach((m) => {
    var f;
    d = (f = m.getInitialState == null ? void 0 : m.getInitialState(d)) != null ? f : d;
  });
  const c = [];
  let g = false;
  const l = {
    ...
    _getRowId: (m, f, x) => {
      var b;
      return (b = o.options.getRowId == null ? void 0 : o.options.getRowId(m, f, x)) != null ? b : `${x ? [x.id, f].join(".") : f}`;
    },
    ...
    _getDefaultColumnDef: R(() => [o.options.defaultColumn], (m) => {
      var f;
      return m = (f = m) != null ? f : {}, {
        header: (x) => {
          const b = x.header.column.columnDef;
          return b.accessorKey ? b.accessorKey : b.accessorFn ? b.id : null;
        },
        // footer: props => props.header.column.id,
        cell: (x) => {
          var b, S;
          return (b = (S = x.renderValue()) == null || S.toString == null ? void 0 : S.toString()) != null ? b : null;
        },
        ...o._features.reduce((x, b) => Object.assign(x, b.getDefaultColumnDef == null ? void 0 : b.getDefaultColumnDef()), {}),
        ...m
      };
    }, _(e, "debugColumns")),
    _getColumnDefs: () => o.options.columns,
    getAllColumns: R(() => [o._getColumnDefs()], (m) => {
      const f = function(x, b, S) {
        return S === void 0 && (S = 0), x.map((h) => {
          const M = co(o, h, S, b), F = h;
          return M.columns = F.columns ? f(F.columns, M, S + 1) : [], M;
        });
      };
      return f(m);
    }, _(e, "debugColumns")),
    getAllFlatColumns: R(() => [o.getAllColumns()], (m) => m.flatMap((f) => f.getFlatColumns()), _(e, "debugColumns")),
    _getAllFlatColumnsById: R(() => [o.getAllFlatColumns()], (m) => m.reduce((f, x) => (f[x.id] = x, f), {}), _(e, "debugColumns")),
    getAllLeafColumns: R(() => [o.getAllColumns(), o._getOrderColumnsFn()], (m, f) => {
      let x = m.flatMap((b) => b.getLeafColumns());
      return f(x);
    }, _(e, "debugColumns")),
    getColumn: (m) => {
  ...
  return (e) => R(() => [e.options.data], (n) => {
    const t = {
      ...
      for (let c = 0; c < o.length; c++) {
        const g = fo(e, e._getRowId(o[c], c, s), o[c], c, a, void 0, s == null ? void 0 : s.id);
        if (t.flatRows.push(g), t.rowsById[g.id] = g, u.push(g), e.options.getSubRows) {
          var d;
          g.originalSubRows = e.options.getSubRows(o[c], c), (d = g.originalSubRows) != null && d.length && (g.subRows = r2(g.originalSubRows, a + 1, g));
        }
      }
      return u;
    };
...
function Ct(e, n) {
  return e ? Wo(e) ? /* @__PURE__ */ w.createElement(e, n) : e : null;
}
function Wo(e) {
  return Ko(e) || typeof e == "function" || Zo(e);
}
function Ko(e) {
...
function Jo(e) {
  const n = {
    ...
    current: Yo(n)
  })), [r2, o] = w.useState(() => t.current.initialState);
...
function cs({
  ...
  const l = Jo({
    ...
    getCoreRowModel: Xo(),
    getRowId: c
  }), m = /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center py-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
  ...
  return ((_a = l.getRowModel().rows) == null ? void 0 : _a.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: p("overflow-hidden rounded-md border", r2), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Qt, { className: o, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(en, { className: "bg-trax-neutral-10", children: l.getHeaderGroups().map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(pt, { className: g == null ? void 0 : g.headerRow, children: f.headers.map((x) => /* @__PURE__ */ jsxRuntimeExports.jsx(tn, { className: g == null ? void 0 : g.headerCell, children: x.isPlaceholder ? null : Ct(
      x.column.columnDef.header,
      x.getContext()
    ) }, x.id)) }, f.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(ao, { children: l.getRowModel().rows.map((f) => {
      const x = a === f.id;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        pt,
        {
          "data-state": f.getIsSelected() && "selected",
          "data-editing": x ? "true" : void 0,
          className: p(
            x && "bg-blue-50 border-blue-200",
            g == null ? void 0 : g.bodyRow
          ),
          children: f.getVisibleCells().map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(so, { className: g == null ? void 0 : g.bodyCell, children: Ct(b.column.columnDef.cell, {
            ...b.getContext(),
            isEditing: x,
            onEdit: () => s == null ? void 0 : s(f),
            onSave: () => u == null ? void 0 : u(f),
            onCancel: d
          }) }, b.id))
        },
        f.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Qt, { className: o, children: /* @__PURE__ */ jsxRuntimeExports.jsx(en, { className: "bg-trax-neutral-10", children: l.getHeaderGroups().map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(pt, { className: g == null ? void 0 : g.headerRow, children: f.headers.map((x) => /* @__PURE__ */ jsxRuntimeExports.jsx(tn, { className: g == null ? void 0 : g.headerCell, children: x.isPlaceholder ? null : Ct(
      x.column.columnDef.header,
      x.getContext()
    ) }, x.id)) }, f.id)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t", children: t || m })
  ] });
}
function fs({
  context: e,
...
const Qo = w.forwardRef(
  ({
    ...
    const M = c || `input-${Math.random().toString(36).substring(2, 11)}`, F = l ? l(m) : {}, [$, T] = w.useState(() => typeof g == "string" ? g : typeof g == "number" ? String(g) : "");
    w.useEffect(() => {
      if (!l && g !== void 0) {
        const H = typeof g == "string" ? g : String(g || "");
        T(H);
      }
    }, [g, l]);
    const D = w.useMemo(() => $.length, [$]), O = u ? D > u : false;
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ut,
          {
            ...
            ...S,
            ...l ? { name: F.name } : { value: g },
            onChange: (H) => {
              T(H.target.value), l ? F.onChange(H) : S.onChange && S.onChange(H);
            },
            onBlur: l ? F.onBlur : f
          }
        ),
        s && u && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: p(
              ...
              O ? "text-trax-red-500" : "text-trax-grey-500"
            ),
            children: [
              D,
              "/",
...
const ea = w.forwardRef(
  ({
    ...
    const b = `select-${Math.random().toString(36).substr(2, 9)}`, S = (h) => {
      h || (m == null ? void 0 : m());
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("flex flex-col gap-1 w-full", c), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        g && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-trax-grey-500 z-10 pointer-events-none", children: g }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(pn, { value: s, onValueChange: u, onOpenChange: S, disabled: d, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Vt,
            {
              ref: x,
              ...
              ...f,
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(hn, { placeholder: o })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(zt, { children: a.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(kt, { value: h.value, children: h.label }, h.value)) })
        ] })
      ] }),
...
const ta = w.forwardRef(
  ({
    ...
    const h = c || `date-picker-${Math.random().toString(36).substr(2, 9)}`, [M, F] = w.useState(false), $ = (D) => {
      u == null ? void 0 : u(D), F(false);
    };
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full", children: [
      n && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(or, { open: M, onOpenChange: (D) => {
        F(D), D || (x == null ? void 0 : x());
      }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ar, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Ge,
          {
            ref: S,
            id: h,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: p(
                "text-left",
                s ? "text-trax-neutral-900" : "text-trax-grey-500"
              ), children: s ? format(s, "yyyy-MM-dd") : a }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4 text-trax-grey-500" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(sr, { className: "w-auto p-0 bg-white", align: "start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          dr,
          {
            mode: "single",
            selected: s,
            onSelect: $,
            disabled: (D) => !!(l && D < l || m && D > m),
            captionLayout: "label",
            fromYear: (l == null ? void 0 : l.getFullYear()) || 1900,
            toYear: (m == null ? void 0 : m.getFullYear()) || (/* @__PURE__ */ new Date()).getFullYear() + 10,
...
ta.displayName = "FormDatePicker";
const na = w.forwardRef(
  ({ label: e, required: n = false, helperText: t, error: r2, id: o, className: a, register: s, registerOptions: u, touched: d, showCharacterCount: c = false, maxCharacters: g, enforceMaxLength: l = false, value: m, ...f }, x) => {
    const b = w.useId(), S = o ?? `textarea-${b}`, h = s ? s(u) : {}, [M, F] = w.useState(() => typeof m == "string" ? m : typeof m == "number" ? String(m) : "");
    w.useEffect(() => {
      if (!s && m !== void 0) {
        const D = typeof m == "string" ? m : String(m || "");
        F(D);
      }
    }, [m, s]);
    const $ = w.useMemo(() => M.length, [M]), T = g ? $ > g : false;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-col gap-1", children: [
      e && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(He, { htmlFor: S, className: "text-xs font-medium text-trax-neutral-900", children: e }),
        n && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-trax-red-400", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          mn,
          {
            ...
            maxLength: l && g ? g : void 0,
            ...f,
            ...s ? { name: h.name } : { value: m },
            onChange: (D) => {
              F(D.target.value), s ? h.onChange(D) : f.onChange && f.onChange(D);
            },
            onBlur: s ? h.onBlur : f.onBlur
          }
        ),
        c && g && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: p(
              "absolute right-3 bottom-2 text-xs font-medium pointer-events-none",
...
na.displayName = "FormTextarea";
const ra = w.forwardRef(({ className: e, indicatorClassName: n, value: t = 0, disabled: r2 = false, error: o, ...a }, s) => {
  const u = Math.max(t, 0), d = !!o, c = () => d ? "bg-trax-red-500" : r2 ? "bg-trax-neutral-100" : "bg-trax-blue-600", g = () => d ? "text-trax-red-500" : r2 ? "text-trax-neutral-100" : "text-trax-neutral-950";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full", children: [
...
ra.displayName = "FormProgress";
function oa(e) {
  return Ht({ attr: { viewBox: "0 0 24 24" }, child: [{ tag: "path", attr: { fill: "none", d: "M0 0h24v24H0z" }, child: [] }, { tag: "path", attr: { d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm5 13.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z" }, child: [] }] })(e);
}
function aa(e, n) {
  if (!n.trim()) return e;
...
function sa({
  ...
  const H = S || `search-select-${w.useId()}`, Y = w.useRef(null), Q = w.useRef(null), se = w.useRef(null), Ce = w.useRef([]), B = h ? h($, M) : {}, [ie, U] = w.useState(""), [N, k] = w.useState(
    a ?? null
  ), [G, me] = w.useState(
    a ?? null
  ), [W, ee] = w.useState(false), [ve, E] = w.useState([]), [L, V] = w.useState("idle"), [j, we] = w.useState(-1), [P, K] = w.useState(false), [Re, Ee] = w.useState(false), [Me, We] = w.useState(false), le = w.useRef(void 0), je = w.useRef(false), Le = w.useRef(false), _e = w.useRef(false), qe = w.useRef(N), ge = w.useRef(G), Ke = w.useRef(P);
  w.useEffect(() => {
    qe.current = N;
  }, [N]), w.useEffect(() => {
    ge.current = G;
  ...
  const Ze = w.useCallback(
    async (C) => {
      if (C.length < c) {
        V("idle"), E([]), ee(false);
        return;
      }
      V("searching"), ee(true), we(-1);
      try {
        const z = await u(C);
        E(z), V(z.length > 0 ? "success" : "no-results");
      } catch (z) {
        console.error("Search error:", z), E([]), V("no-results");
      }
    },
    [u, c]
  );
  w.useEffect(() => (le.current && clearTimeout(le.current), ie && !je.current && !Le.current && !_e.current ? le.current = setTimeout(() => {
    Ze(ie);
  }, d) : ie || (ee(false), V("idle"), E([])), () => {
    le.current && clearTimeout(le.current);
  }), [ie, d, Ze]), w.useEffect(() => {
    a !== void 0 && (k(a), me(a), a && U(a.label));
  }, [a]), w.useEffect(() => {
    var _a;
    const C = Q.current || ((_a = se.current) == null ? void 0 : _a.querySelector("input"));
    let z = true;
    const be = () => {
      if (z)
        if (C && N && !P) {
          const de = C.scrollWidth > C.offsetWidth;
          We(de);
        } else
          We(false);
    };
    ...
    return oe.observe(C), () => {
      z = false, oe.disconnect();
    };
  }, [N, P, Re, D]);
  const re2 = (C) => {
    const z = C.target.value;
    U(z), K(true), N && z !== N.label && (k(null), T === false && !h || (h && B.onChange({ target: { name: $, value: null } }), s == null ? void 0 : s(null)));
  }, Ne = (C) => {
    Le.current = true, k(C), me(C), U(C.label), ee(false), K(false), V("idle"), h && B.onChange({ target: { name: $, value: C } }), s == null ? void 0 : s(C), setTimeout(() => {
      Le.current = false;
    }, 0);
  }, Je = (C) => {
    var _a;
    C.stopPropagation(), k(null), me(null), U(""), ee(false), V("idle"), K(false), h && B.onChange({ target: { name: $, value: null } }), s == null ? void 0 : s(null), (_a = Q.current) == null ? void 0 : _a.focus();
  }, gt = () => {
    Ee(true), N && !P && U("");
  }, Oe = (C) => {
    _e.current = true, Ee(false), le.current && clearTimeout(le.current), setTimeout(() => {
      var _a;
      ((_a = Y.current) == null ? void 0 : _a.contains(document.activeElement)) || (ee(false), V("idle"), E([]), T ? !N && P && (U(""), K(false), h && B.onChange({ target: { name: $, value: null } }), s == null ? void 0 : s(null)) : P && G && !N ? (k(G), U(G.label), K(false), h && B.onChange({ target: { name: $, value: G } }), s == null ? void 0 : s(G)) : !N && !G && (U(""), K(false))), setTimeout(() => {
        _e.current = false;
      }, 100);
    }, 200), h && B.onBlur(C), F == null ? void 0 : F(C);
  }, ft = (C) => {
    if ((C.key === "Backspace" || C.key === "Delete") && (C.metaKey || C.ctrlKey || C.altKey) && N) {
      C.preventDefault(), Je(C);
      return;
    }
    if (W)
      switch (C.key) {
        case "ArrowDown":
          C.preventDefault(), we(
            (z) => z < ve.length - 1 ? z + 1 : z
          );
          break;
        case "ArrowUp":
          C.preventDefault(), we((z) => z > 0 ? z - 1 : -1);
          break;
        case "Enter":
          C.preventDefault(), j >= 0 && ve[j] && Ne(ve[j]);
          break;
        case "Escape":
          C.preventDefault(), ee(false), V("idle"), G ? (k(G), U(G.label), K(false)) : (U(""), k(null));
          break;
      }
  };
  w.useEffect(() => {
    var _a;
    j >= 0 && Ce.current[j] && ((_a = Ce.current[j]) == null ? void 0 : _a.scrollIntoView({
      block: "nearest",
      behavior: "smooth"
    }));
  }, [j]);
  const Ae = w.useCallback((C) => {
    var _a, _b, _c;
    const z = C.target, be = Q.current || h && ((_a = se.current) == null ? void 0 : _a.querySelector("input"));
    if (be && !be.contains(z) && !((_b = Y.current) == null ? void 0 : _b.contains(z)) && !((_c = se.current) == null ? void 0 : _c.contains(z))) {
      le.current && clearTimeout(le.current), ee(false), V("idle"), E([]), Ee(false);
      const oe = qe.current, de = ge.current, et = Ke.current;
      T ? !oe && et && (U(""), K(false), h && B.onChange({ target: { name: $, value: null } }), s == null ? void 0 : s(null)) : et && de && !oe ? (k(de), U(de.label), K(false), h && B.onChange({ target: { name: $, value: de } }), s == null ? void 0 : s(de)) : !oe && !de && (U(""), K(false));
    }
  }, [h, T, $, B, s]);
  w.useEffect(() => {
    if (W)
  ...
  const Ve = N && !P ? !Re && D ? D : N.label : ie, Fe = Me && N && !P && !((O == null ? void 0 : O.disabled) ?? false), Qe = /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: se, className: "relative", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ut,
      {
        ref: h ? B.ref : Q,
        ...
        onCompositionEnd: (C) => {
          je.current = false, U(C.target.value);
        }
      }
    ),
    Re && (N || ie) && !b && /* @__PURE__ */ jsxRuntimeExports.jsx(
      Ge,
      {
        type: "button",
        onClick: Je,
        ...
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(oa, {}),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: p("flex flex-col gap-1 w-full relative", x), children: [
    e && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(He, { htmlFor: H, className: "text-xs font-medium text-trax-neutral-900", children: e }),
      n && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-trax-red-400", children: "*" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(vr, { delayDuration: (O == null ? void 0 : O.delayDuration) ?? 300, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(wr, { asChild: true, disabled: !Fe, children: Qe }),
      Fe && /* @__PURE__ */ jsxRuntimeExports.jsx(
        Sr,
        {
          variant: (O == null ? void 0 : O.variant) ?? "light",
          showArrow: (O == null ? void 0 : O.showArrow) ?? false,
          size: (O == null ? void 0 : O.size) ?? "sm",
          children: (O == null ? void 0 : O.renderContent) ? O.renderContent(Ve) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "max-w-xs wrap-break-word", children: Ve })
        }
      )
    ] }),
    W && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: Y,
        id: `${H}-dropdown`,
        ...
        children: [
          L === "searching" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-3 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(wn, { className: "w-6 h-6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-trax-neutral-600", children: g })
          ] }),
          L === "no-results" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-trax-neutral-400", children: l }) }),
          L === "success" && ve.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: ve.map((C, z) => {
            const be = z === j;
            return /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                className: p(
                  ...
                  be && "bg-trax-neutral-20",
                  "hover:bg-trax-primary-blue-50",
                  "active:bg-trax-primary-blue-100"
                ),
                children: m ? m(C, (oe, de) => f(oe, de)) : f(C.label, ie)
              },
              C.value
            );
          }) })
...
const ia = w.forwardRef(
  ({
    ...
    const [c, g] = w.useState(false), l = w.useRef(null), m = (h) => {
      h.preventDefault(), s || g(true);
    }, f = (h) => {
      h.preventDefault(), g(false);
    }, x = (h) => {
      if (h.preventDefault(), g(false), s) return;
      const M = h.dataTransfer.files;
      M && M.length > 0 && (n == null ? void 0 : n(M));
    }, b = () => {
...
Dn.displayName = "SectionHeader";
const la = w.forwardRef(
  ({
    className: e,
    title: n,
    icon: t,
...
la.displayName = "CollapsibleSection";
const da = w.forwardRef(
  ({
    ...
    const g = t.reduce((l, m) => l + m.percentage, 0);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: c,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-center f-full gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Tt, { value: g || 3, className: "h-2", indicatorClassName: "bg-trax-neutral-100" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-trax-neutral-100", children: [
              g,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-1.5", children: t.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between bg-grey-50 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(lr, { variant: "category", children: l.name }) }, l.id)) }),
...
da.displayName = "CostAllocation";
function on(e, n, t = "narrow") {
  var _a;
...
const ua = w.forwardRef(
  ({
    ...
    const T = l || `currency-input-${Math.random().toString(36).substring(2, 11)}`, D = t ?? (n ? on(n, r2, s) : void 0), O = o ?? (D ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-xs", "aria-hidden": true, children: D }) : null), H = a ?? (m && f.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      pn,
      {
        value: n,
        onValueChange: (Y) => {
          const Q = f.find((se) => se.code === Y);
          Q && x && x(Q);
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Vt, { className: "h-6 border-0 shadow-none bg-transparent hover:bg-gray-50 focus:ring-0 focus:ring-offset-0 px-2 py-1 text-xs font-medium text-trax-grey-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(hn, { children: n }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(zt, { children: f.map((Y) => {
            const Q = Y.symbol ?? on(Y.code, Y.locale || r2, s);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(kt, { value: Y.code, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: Q }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: Y.code })
            ] }) }, Y.code);
          }) })
        ]
      }
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Jn, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Qn, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Ge,
            {
              disabled: s,
              variant: o,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(er, { align: "end", className: "min-w-[200px]", children: t.map((c, g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            tr,
            {
              onClick: c.onClick,
...
ca.displayName = "SplitButton";
const ps = Root$8, ga = Portal$4, Pn = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Overlay,
  {
    ref: t,
    className: Se(
...
Pn.displayName = Overlay.displayName;
const fa = w.forwardRef(({ className: e, children: n, showCloseButton: t = true, ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsxs(ga, { children: [
  /* @__PURE__ */ jsxRuntimeExports.jsx(Pn, {}),
  /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Content$1,
    {
      ref: o,
...
fa.displayName = Content$1.displayName;
const ma = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
ma.displayName = "CustomDialogHeader";
const pa = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
pa.displayName = "CustomDialogFooter";
const ha = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Title,
  {
    ref: t,
    className: p(
...
ha.displayName = Title.displayName;
const xa = w.forwardRef(({ className: e, ...n }, t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
  Description,
  {
    ref: t,
...
xa.displayName = Description.displayName;
