...
import { E as ExpenseFormType, u as useCreateExpenseType, a as useUpdateExpenseType, b as useToggleExpenseTypeStatus, c as useFormTypeOptions, d as useMileageRateOptions, e as useExpenseTypes } from "./api-B7ZJOk-0.js";
import { P as Plus, u as useCompanyStore, L as LoadingSpinner } from "./LoadingSpinner-BqLZLzEJ.js";
import { G as Ge, Q as Qo, e as ea, g as fs, j as m, k as dr, n as ar, s as sr, o as ir, q as cs } from "./createLucideIcon-CJLbBnZK.js";
import { o as object, n as number, _ as _enum, s as string, l as literal, d as useForm, e as a, C as Controller } from "./zod-D5pnVYPu.js";
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      fs,
      {
        ...
        viewContent: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: m("size-2 rounded-full", statusConfig.color), "data-testid": `status-indicator-${rowData.id}` }),
...
const getFormTypeBadge = (formType, mileage) => {
  switch (formType) {
    case "standard":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(dr, { variant: "outline", className: "text-trax-blue-600 bg-trax-primary-blue-50", children: EXPENSE_TYPE_LABELS.STANDARD });
    case "entertainment":
      return /* @__PURE__ */ jsxRuntimeExports.jsx(dr, { variant: "outline", className: "text-trax-green-800 bg-trax-green-100", children: EXPENSE_TYPE_LABELS.ENTERTAINMENT });
    case "mileage":
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 flex-nowrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(dr, { variant: "outline", className: "text-trax-yellow-800 bg-trax-yellow-100", children: EXPENSE_TYPE_LABELS.MILEAGE }),
        mileage && /* @__PURE__ */ jsxRuntimeExports.jsx(dr, { variant: "outline", className: "bg-trax-neutral-20 text-trax-grey-900", children: `$${mileage}/mile` })
      ] });
    default:
      return null;
  }
...
const createActionsColumn = ({
  ...
  cell: (context) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(ar, { children: [
