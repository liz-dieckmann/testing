...
let moduleMap = {
  "./mount": () => {
    ...
    return __federation_import("./assets/__federation_expose_Mount-D4c-B9wO.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }
};
const seen = {};
