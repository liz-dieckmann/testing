...
const EXPENSE_ENDPOINTS = {
  ...
  // Unified endpoint - returns expense regardless of status (draft or submitted)
  GET_EXPENSE_BY_ID: (id) => `/api/v1.0/expense/${id}`
};
...
const ENDPOINT_PATTERNS = {
  ...
  // Unified endpoint - searches both drafts and submitted
  EXPENSE_BY_ID_UNIFIED: "*/api/v1.0/expense/:id",
  // Mileage Trips
...
const ENDPOINT_REGEX = {
  ...
  EXPENSES_LIST_UNIFIED: /\/api\/v1\.0\/expenses-list/,
  // Unified expense endpoint (singular) - searches both drafts and submitted
  EXPENSE_BY_ID: /\/api\/v1\.0\/expense\/[^/]+$/,
