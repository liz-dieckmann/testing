import { c as createLucideIcon } from "./createLucideIcon-DxTSH2Gc.js";
import { importShared } from "./__federation_fn_import-DD1J_cWq.js";
import { j as jsxRuntimeExports } from "./jsx-runtime-CzdF90_e.js";
import { c as create, d as devtools, s as subscribeWithSelector, i as immer } from "./axiosInstance-Df66sy1J.js";
const __iconNode = [
...
const queryKeys = {
  ...
  expenseDrafts: {
    all: () => ["expenseDrafts"],
    lists: () => [...queryKeys.expenseDrafts.all(), "list"],
    list: () => [...queryKeys.expenseDrafts.lists()],
    details: () => [...queryKeys.expenseDrafts.all(), "detail"],
    detail: (id) => [...queryKeys.expenseDrafts.details(), id]
  },
  mileageTrips: {
    all: () => ["mileageTrips"],
    lists: () => [...queryKeys.mileageTrips.all(), "list"],
    list: () => [...queryKeys.mileageTrips.lists()],
    details: () => [...queryKeys.mileageTrips.all(), "detail"],
    detail: (id) => [...queryKeys.mileageTrips.details(), id]
  },
  mileageDrafts: {
    all: () => ["mileageDrafts"],
    lists: () => [...queryKeys.mileageDrafts.all(), "list"],
    list: () => [...queryKeys.mileageDrafts.lists()],
    details: () => [...queryKeys.mileageDrafts.all(), "detail"],
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-full w-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: `
        ...
        size-12 text-[#87AFBB]    /* дефолт: 48px і потрібний колір */
        ${className ?? ""}
      `,
      role: "img",
      "aria-label": "Loading",
