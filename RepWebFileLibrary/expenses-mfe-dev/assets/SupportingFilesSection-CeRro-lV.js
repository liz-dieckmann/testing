...
import { w as us, J as gs, K as fs, N as ps, P as hs, Q as ms, M as Me, S as Sn, b as apiClient, o as os, l as ls, a as as, A as An, a2 as Dt, a3 as $a, a4 as za, F as Fa, $ as $r, f as Vr, z as zr, a5 as Ms, a6 as Ps, a7 as $s, k as ks } from "./axiosInstance-Wzm5FGtt.js";
import { I as Icon } from "./Icon-mtRo2MvL.js";
import { E as ECostAllocation } from "./cost-allocation-DRGo4_AN.js";
import { P as Plus } from "./plus-CHwUTiVc.js";
import "./config-Dtx7ka0E.js";
import { _ as __vitePreload } from "./preload-helper-e_IRvegh.js";
import { F as FILE_ENDPOINTS } from "./endpoints-B5IysDN2.js";
...
const { useCallback: useCallback$3, useEffect: useEffect$2, useRef: useRef$2, useState: useState$3 } = React$2;
const ReceiptUpload = ({
  onReceiptChange,
  onUploadingChange,
  initialReceipt,
  ...
  const renderErrorState = () => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full items-center justify-center p-8 text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Me, { variant: "soft", size: "sm", onClick: handleChooseFileClick, children: "Choose file" })
    ] });
  };
...
const { Fragment, memo: memo$2, useCallback: useCallback$2, useContext, useMemo: useMemo$2, useState: useState$2 } = await importShared("react");
...
const { memo, useState: useState$1, useCallback: useCallback$1 } = await importShared("react");
const AddAllocationExpandable = memo(({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ms, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ps, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Me, { variant: "outlined", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, {}), disabled, children: COST_ALLOCATION_LABELS.ADD_ALLOCATION }) }),
...
export {
  ...
  createValidationStrategy as l,
  mapMileageTripToDefaultValues as m,
  additionalCommentsFieldOptional as n,
