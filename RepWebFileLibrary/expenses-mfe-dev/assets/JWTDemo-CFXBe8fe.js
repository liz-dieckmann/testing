...
import { c as createLucideIcon, u as useJWTStore, q as jwtSelectors, r as ensureJWTInitialized, D as DOMEventNames, o as os, _ as _r, s as ft, T as TokenPlaceholders, M as Me, t as Ot, v as bn, b as apiClient } from "./axiosInstance-Wzm5FGtt.js";
import { S as Shield } from "./shield-DKtnQAOH.js";
import { C as Clock } from "./clock-DaFWPV8d.js";
...
const JWTDemo = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6 max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(os, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(_r, { ...getStatusBadgeProps() })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(os, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(os, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        tokenExpiration.expiresAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Ot, { value: getTimeProgress(), className: "h-2" }),
    ...
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs(os, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ft, { value: user.id || "N/A", readOnly: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ft, { value: user.name || "N/A", readOnly: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ft, { value: user.email || "N/A", readOnly: true })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Roles" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: roles.length > 0 ? roles.map((role) => /* @__PURE__ */ jsxRuntimeExports.jsx(_r, { variant: "secondary", children: role }, role)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No roles assigned" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Permissions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: permissions.length > 0 ? permissions.map((permission) => /* @__PURE__ */ jsxRuntimeExports.jsx(_r, { variant: "outline", children: permission }, permission)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No permissions granted" }) })
          ] })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(os, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Me, { onClick: handleSetDemoToken, className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { className: "h-4 w-4" }),
            "Set Demo Token"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Me, { variant: "destructive", onClick: handleClearToken, className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }),
            "Clear Token"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Me, { variant: "outline", onClick: handleTestAPI, className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(os, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Me, { onClick: handleEmitEvent, className: "w-full", children: "Emit JWT Update Event" }),
