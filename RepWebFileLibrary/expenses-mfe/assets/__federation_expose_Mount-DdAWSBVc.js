const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=[(()=>{const f="assets/ExpensesPage-DaTnf6wi.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/jsx-runtime-DLKWXVrv.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensesList-Xh6VcRDy.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/createLucideIcon-DIm8u9Oh.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/__federation_fn_import-DlFISMuz.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-67r_Wbag.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensePage-DaqwxL_C.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Icon-CLuFtx_9.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/preload-helper-e_IRvegh.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/LoadingSpinner-C-M1heDl.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-BjxWsBul.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/axiosInstance-BPwdN1IK.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/endpoints-DyuQahSx.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/schemas-BbJoaiI5.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/routes-D_bdpp_f.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/send-BFf406_z.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Configurations-CgUIRpiX.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/CorporateCards-BGn--eZB.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Payroll-CHdye5gV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Allocations-C-yIwG6T.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpenseType-ClCxqvM8.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-CtcpRdCV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-CKuDCJe0.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/layout-dashboard-B6fg-6E-.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/BusinessPurpose-BJNOyvLy.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/JWTDemo-CYS7zre2.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/shield-BWirFEgK.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/IconsTestingPage-PbUGVfmS.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/mockingStrategy-CEuqMBDg.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})()])))=>i.map(i=>d[i]);
...
import { R as RouterProvider$1, u as useNavigate, L as Link, a as RoutePaths, F as FileText, C as ChartColumn, b as RouteNames, c as CreditCard, d as RouteCompanyLabels, e as RouteCompanyIds, f as ChevronRight, N as NavLink, g as useLocation, h as useParams, i as RoutePathConfigChunks, O as Outlet, j as createHashRouter } from "./routes-D_bdpp_f.js";
import { c as createLucideIcon, W as Wo, D as De, B as Bo, j as ja } from "./createLucideIcon-DIm8u9Oh.js";
import { P as Plus, Q as Query, u as useCompanyStore, a as useQuery } from "./store-CtcpRdCV.js";
import { R as Receipt } from "./receipt-67r_Wbag.js";
import { S as Shield } from "./shield-BWirFEgK.js";
...
const Expenses = lazy(() => __vitePreload(() => import("./ExpensesPage-DaTnf6wi.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url));
const NewExpense = lazy(() => __vitePreload(() => import("./ExpensePage-DaqwxL_C.js"), true ? __vite__mapDeps([6,4,1,2,3,5,7,8,9,10,11,12,13,14,15]) : void 0, import.meta.url));
...
const ExpensesType = lazy(() => __vitePreload(() => import("./ExpenseType-ClCxqvM8.js"), true ? __vite__mapDeps([20,1,4,21,3,9,11,13,22,23]) : void 0, import.meta.url));
const BusinessPurpose = lazy(() => __vitePreload(() => import("./BusinessPurpose-BJNOyvLy.js"), true ? __vite__mapDeps([24,1,4,21,3,9,11,13,22,12,7,8]) : void 0, import.meta.url));
const TestingAuthentication = lazy(() => __vitePreload(() => import("./JWTDemo-CYS7zre2.js"), true ? __vite__mapDeps([25,4,1,11,3,26,15]) : void 0, import.meta.url));
const TestingIcons = lazy(() => __vitePreload(() => import("./IconsTestingPage-PbUGVfmS.js"), true ? __vite__mapDeps([27,4,1,7,8]) : void 0, import.meta.url));
...
async function initializeMocking() {
  const { mockingStrategy } = await __vitePreload(async () => {
    const { mockingStrategy: mockingStrategy2 } = await import("./mockingStrategy-CEuqMBDg.js");
