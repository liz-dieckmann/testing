const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=[(()=>{const f="assets/ExpensesPage-yMOTwzvh.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/jsx-runtime-DLKWXVrv.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensesList-DGl4tmT2.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/createLucideIcon-1g8Meoed.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/__federation_fn_import-DlFISMuz.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-BpZDL73r.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensePage-S_avNgVH.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Icon-CLuFtx_9.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/preload-helper-e_IRvegh.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/LoadingSpinner-C-M1heDl.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-BjxWsBul.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/axiosInstance-BPwdN1IK.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/endpoints-B6EuaDvp.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/useMutation-BddyCFSz.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/routes-DHOTgDBz.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/send-jC1ojNZN.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Configurations-CgUIRpiX.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/CorporateCards-BGn--eZB.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Payroll-CHdye5gV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Allocations-C-yIwG6T.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpenseType-U2C5OMlV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-DXLMsw7L.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/schemas-bpbGosa0.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/layout-dashboard-DI6o6BGE.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/BusinessPurpose-4IfIdbEt.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/JWTDemo-DCj8FqUW.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/shield-BH5wtbbm.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/IconsTestingPage-BYtv4I2p.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/mockingStrategy-Bw5eCNwa.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})()])))=>i.map(i=>d[i]);
...
import { R as RouterProvider$1, u as useNavigate, L as Link, a as RoutePaths, F as FileText, C as ChartColumn, b as RouteNames, c as CreditCard, d as RouteCompanyLabels, e as RouteCompanyIds, f as ChevronRight, N as NavLink, g as useLocation, h as useParams, i as RoutePathConfigChunks, O as Outlet, j as createHashRouter } from "./routes-DHOTgDBz.js";
import { c as createLucideIcon, W as Wo, D as De, B as Bo, j as ja } from "./createLucideIcon-1g8Meoed.js";
import { P as Plus, Q as Query, u as useCompanyStore, a as useQuery } from "./store-DXLMsw7L.js";
import { R as Receipt } from "./receipt-BpZDL73r.js";
...
const Expenses = lazy(() => __vitePreload(() => import("./ExpensesPage-yMOTwzvh.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url));
const NewExpense = lazy(() => __vitePreload(() => import("./ExpensePage-S_avNgVH.js"), true ? __vite__mapDeps([6,4,1,2,3,5,7,8,9,10,11,12,13,14,15]) : void 0, import.meta.url));
...
const ExpensesType = lazy(() => __vitePreload(() => import("./ExpenseType-U2C5OMlV.js"), true ? __vite__mapDeps([20,1,4,21,3,9,11,13,22,23]) : void 0, import.meta.url));
const BusinessPurpose = lazy(() => __vitePreload(() => import("./BusinessPurpose-4IfIdbEt.js"), true ? __vite__mapDeps([24,1,4,21,3,9,11,13,22,12,7,8]) : void 0, import.meta.url));
const TestingAuthentication = lazy(() => __vitePreload(() => import("./JWTDemo-DCj8FqUW.js"), true ? __vite__mapDeps([25,4,1,11,3,26,15]) : void 0, import.meta.url));
const TestingIcons = lazy(() => __vitePreload(() => import("./IconsTestingPage-BYtv4I2p.js"), true ? __vite__mapDeps([27,4,1,7,8]) : void 0, import.meta.url));
...
async function initializeMocking() {
  const { mockingStrategy } = await __vitePreload(async () => {
    const { mockingStrategy: mockingStrategy2 } = await import("./mockingStrategy-Bw5eCNwa.js");
