const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=[(()=>{const f="assets/ExpensesPage-ltJ5D2_y.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/jsx-runtime-DLKWXVrv.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensesList-CVCqX-cX.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/createLucideIcon-DyT7YbiM.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/__federation_fn_import-DlFISMuz.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-Cbn6Sx0z.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpensePage-DYOo9KR0.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Icon-CLuFtx_9.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/preload-helper-e_IRvegh.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/LoadingSpinner-C-M1heDl.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/receipt-BjxWsBul.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/axiosInstance-BPwdN1IK.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/endpoints-B6EuaDvp.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/schemas-BbJoaiI5.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/routes-YnS7qqhP.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/send-BD6-HR5P.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Configurations-CgUIRpiX.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/CorporateCards-BGn--eZB.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Payroll-CHdye5gV.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/Allocations-C-yIwG6T.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/ExpenseType-CaNLVdiP.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-oS9xoGUM.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/store-2hzq8Sto.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/layout-dashboard-BMYgnuBm.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/BusinessPurpose-j2TksHl2.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/JWTDemo-kghIVZTX.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/shield-ngSvX0QB.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/IconsTestingPage-CanvGCAs.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})(),(()=>{const f="assets/mockingStrategy-DjlrEiv8.js";const rel=f.startsWith('assets/')?f.slice(7):f;return new URL(rel, import.meta.url).href;})()])))=>i.map(i=>d[i]);
...
import { R as RouterProvider$1, u as useNavigate, L as Link, a as RoutePaths, F as FileText, C as ChartColumn, b as RouteNames, c as CreditCard, d as RouteCompanyLabels, e as RouteCompanyIds, f as ChevronRight, N as NavLink, g as useLocation, h as useParams, i as RoutePathConfigChunks, O as Outlet, j as createHashRouter } from "./routes-YnS7qqhP.js";
import { c as createLucideIcon, W as Wo, D as De, B as Bo, j as ja } from "./createLucideIcon-DyT7YbiM.js";
import { P as Plus, Q as Query, u as useCompanyStore, a as useQuery } from "./store-oS9xoGUM.js";
import { R as Receipt } from "./receipt-Cbn6Sx0z.js";
import { S as Shield } from "./shield-ngSvX0QB.js";
import { L as LayoutDashboard } from "./layout-dashboard-BMYgnuBm.js";
...
const Expenses = lazy(() => __vitePreload(() => import("./ExpensesPage-ltJ5D2_y.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0, import.meta.url));
const NewExpense = lazy(() => __vitePreload(() => import("./ExpensePage-DYOo9KR0.js"), true ? __vite__mapDeps([6,4,1,2,3,5,7,8,9,10,11,12,13,14,15]) : void 0, import.meta.url));
...
const ExpensesType = lazy(() => __vitePreload(() => import("./ExpenseType-CaNLVdiP.js"), true ? __vite__mapDeps([20,1,4,21,3,9,11,13,22,23]) : void 0, import.meta.url));
const BusinessPurpose = lazy(() => __vitePreload(() => import("./BusinessPurpose-j2TksHl2.js"), true ? __vite__mapDeps([24,1,4,21,3,9,11,13,22,12,7,8]) : void 0, import.meta.url));
const TestingAuthentication = lazy(() => __vitePreload(() => import("./JWTDemo-kghIVZTX.js"), true ? __vite__mapDeps([25,4,1,11,3,26,15]) : void 0, import.meta.url));
const TestingIcons = lazy(() => __vitePreload(() => import("./IconsTestingPage-CanvGCAs.js"), true ? __vite__mapDeps([27,4,1,7,8]) : void 0, import.meta.url));
...
async function initializeMocking() {
  const { mockingStrategy } = await __vitePreload(async () => {
    const { mockingStrategy: mockingStrategy2 } = await import("./mockingStrategy-DjlrEiv8.js");
