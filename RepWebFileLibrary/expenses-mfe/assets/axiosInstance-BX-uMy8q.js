import { c as RouteCompanyIds } from "./routes-B2R0Jdp4.js";
...
const mockFormTypeOptions = [
  {
    id: "form-type-1",
    value: ExpenseFormType.STANDARD,
    label: "Standard",
    description: "Standard expense form for general business expenses",
    isActive: true,
    created: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z"),
    modified: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z")
  },
  {
    id: "form-type-2",
    value: ExpenseFormType.ENTERTAINMENT,
    label: "Entertainment",
    description: "Entertainment expense form for client meals and business events",
    isActive: true,
    created: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z"),
    modified: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z")
  },
  {
    id: "form-type-3",
    value: ExpenseFormType.MILEAGE,
    label: "Mileage",
    description: "Mileage expense form for vehicle-related business travel",
    isActive: true,
    created: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z"),
    modified: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z")
  }
];
const mockMileageRateOptions = [
  {
    id: "mileage-rate-1",
    value: "0.655",
    label: "$0.655/mile",
    rate: 0.655,
    description: "2023 IRS standard mileage rate",
    isActive: false,
    effectiveDate: /* @__PURE__ */ new Date("2023-01-01T00:00:00Z"),
    created: /* @__PURE__ */ new Date("2023-01-01T00:00:00Z"),
    modified: /* @__PURE__ */ new Date("2023-01-01T00:00:00Z")
  },
  {
    id: "mileage-rate-2",
    value: "0.67",
    label: "$0.67/mile",
    rate: 0.67,
    description: "2024 IRS standard mileage rate (current)",
    isActive: true,
    effectiveDate: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z"),
    created: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z"),
    modified: /* @__PURE__ */ new Date("2024-01-01T00:00:00Z")
  },
  {
    ...
    label: "$0.585/mile",
    rate: 0.585,
    description: "2022 IRS standard mileage rate (legacy)",
    isActive: false,
    effectiveDate: /* @__PURE__ */ new Date("2022-01-01T00:00:00Z"),
    created: /* @__PURE__ */ new Date("2022-01-01T00:00:00Z"),
    modified: /* @__PURE__ */ new Date("2022-01-01T00:00:00Z")
  }
];
...
Object.keys(mockExpenseTypes).forEach((key) => {
  const companyId = key;
  const originalArray = mockExpenseTypes[companyId] || [];
  dynamicExpenseTypes[companyId] = Array.from(originalArray, (item) => ({ ...item }));
});
          ...
          if (method === "POST" && (url == null ? void 0 : url.includes("/expense-types"))) {
            ...
            if (companyId) {
              try {
                ...
                const existingItems = dynamicExpenseTypes[typedCompanyId] || [];
                const newItemsArray = Array.from(existingItems);
                const updatedArray = newItemsArray.concat([created]);
                dynamicExpenseTypes[typedCompanyId] = updatedArray;
                console.log("🔥 POST: Successfully created new array using concat! New length:", dynamicExpenseTypes[typedCompanyId].length);
                console.log("🔥 POST: New array is extensible?", Object.isExtensible(dynamicExpenseTypes[typedCompanyId]));
