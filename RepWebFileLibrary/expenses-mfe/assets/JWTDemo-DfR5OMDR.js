...
import { u as useJWTStore, j as jwtSelectors, e as ensureJWTInitialized, D as DOMEventNames, T as TokenPlaceholders, a as apiClient } from "./axiosInstance-BX-uMy8q.js";
import { c as createLucideIcon, m as ma, d as ar, g as ht, D as De, o as on, i as Qt } from "./createLucideIcon-Buj3b33L.js";
import { S as Shield } from "./shield-DwNUn5t9.js";
import { C as CircleCheckBig } from "./circle-check-big-Ca60fBYi.js";
import { S as Send } from "./send-DjaKLFnC.js";
/**
...
const JWTDemo = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-6 space-y-6 max-w-6xl", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ma, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ar, { ...getStatusBadgeProps() })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ma, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ma, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        tokenExpiration.expiresAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(on, { value: getTimeProgress(), className: "h-2" }),
    ...
    user && /* @__PURE__ */ jsxRuntimeExports.jsxs(ma, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ht, { value: user.id || "N/A", readOnly: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ht, { value: user.name || "N/A", readOnly: true })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ht, { value: user.email || "N/A", readOnly: true })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Roles" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: roles.length > 0 ? roles.map((role) => /* @__PURE__ */ jsxRuntimeExports.jsx(ar, { variant: "secondary", children: role }, role)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No roles assigned" }) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Permissions" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 mt-1", children: permissions.length > 0 ? permissions.map((permission) => /* @__PURE__ */ jsxRuntimeExports.jsx(ar, { variant: "outline", children: permission }, permission)) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-500", children: "No permissions granted" }) })
          ] })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ma, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(De, { onClick: handleSetDemoToken, className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Key, { className: "h-4 w-4" }),
            "Set Demo Token"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(De, { variant: "destructive", onClick: handleClearToken, className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { className: "h-4 w-4" }),
            "Clear Token"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(De, { variant: "outline", onClick: handleTestAPI, className: "flex items-center gap-2", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(ma, { className: "p-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(De, { onClick: handleEmitEvent, className: "w-full", children: "Emit JWT Update Event" }),
