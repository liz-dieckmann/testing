...
const se = cva(
  ...
  ({
    ...
    const d = o ? Slot$4 : "button", g = r2 === "center" || !i && a;
...
const ve = R.forwardRef(({ className: e, children: n, position: t = "popper", ...r2 }, o) => /* @__PURE__ */ jsxRuntimeExports.jsx(Portal$1, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
  Content2$1,
  {
    ...
    ...r2,
    children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Be, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Viewport,
        {
          className: f(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(je, {})
    ]
  }
) }));
...
function Pt({ className: e, variant: n, ...t }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: f($t({ variant: n }), e), ...t });
}
function Mt({
  className: e,
  classNames: n,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    DayPicker,
    {
      ...
      classNames: {
        ...
        month: f("flex flex-col w-full gap-4", u.month),
        nav: f(
        ...
        weekdays: f("flex", u.weekdays),
        weekday: f(
          "text-muted-foreground rounded-md flex-1 font-normal text-[0.8rem] select-none",
          u.weekday
        ),
        week: f("flex w-full mt-2", u.week),
        ...
        range_middle: f("rounded-none", u.range_middle),
        range_end: f("rounded-r-md bg-accent", u.range_end),
        today: f(
        ...
        hidden: f("invisible", u.hidden),
        ...n
      },
      components: {
        Root: ({ className: d, rootRef: g, ...m }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            "data-slot": "calendar",
            ref: g,
        ...
        Chevron: ({ className: d, orientation: g, ...m }) => g === "left" ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronLeft, { className: f("size-4", d), ...m }) : g === "right" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChevronRight,
          {
            className: f("size-4", d),
            ...m
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: f("size-4", d), ...m }),
        DayButton: It,
        WeekNumber: ({ children: d, ...g }) => /* @__PURE__ */ jsxRuntimeExports.jsx("td", { ...g, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex size-(--cell-size) items-center justify-center text-center", children: d }) }),
        ...i
      },
      ...s
    }
...
qe.displayName = Root.displayName;
...
function C(e, n, t) {
  ...
  return (a) => {
    ...
    const s = e(a);
    if (!(s.length !== r2.length || s.some((g, m) => r2[m] !== g)))
      return o;
    r2 = s;
    let d;
    if (t.key && t.debug && (d = Date.now()), o = n(...s), t == null || t.onChange == null || t.onChange(o), t.key && t.debug && t != null && t.debug()) {
      const g = Math.round((Date.now() - i) * 100) / 100, m = Math.round((Date.now() - d) * 100) / 100, p = m / 16, c = (h, x) => {
...
function Ht(e, n, t, r2) {
  var o, a;
  const s = {
    ...e._getDefaultColumnDef(),
    ...n
  }, u = s.accessorKey;
  let d = (o = (a = s.id) != null ? a : u ? typeof String.prototype.replaceAll == "function" ? u.replaceAll(".", "_") : u.replace(/\./g, "_") : void 0) != null ? o : typeof s.header == "string" ? s.header : void 0, g;
  if (s.accessorFn ? g = s.accessorFn : u && (u.includes(".") ? g = (p) => {
    let c = p;
    for (const x of u.split(".")) {
      var h;
      c = (h = c) == null ? void 0 : h[x];
    }
    return c;
  } : g = (p) => p[s.accessorKey]), !d)
    throw new Error();
  let m = {
    id: `${String(d)}`,
    accessorFn: g,
...
const At = {
  createTable: (e) => {
    e.getHeaderGroups = C(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (n, t, r2, o) => {
      var a, i;
      const s = (a = r2 == null ? void 0 : r2.map((m) => t.find((p) => p.id === m)).filter(Boolean)) != null ? a : [], u = (i = o == null ? void 0 : o.map((m) => t.find((p) => p.id === m)).filter(Boolean)) != null ? i : [], d = t.filter((m) => !(r2 != null && r2.includes(m.id)) && !(o != null && o.includes(m.id)));
      return K(n, [...s, ...d, ...u], e);
    }, S(e.options, I)), e.getCenterHeaderGroups = C(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left, e.getState().columnPinning.right], (n, t, r2, o) => (t = t.filter((a) => !(r2 != null && r2.includes(a.id)) && !(o != null && o.includes(a.id))), K(n, t, e, "center")), S(e.options, I)), e.getLeftHeaderGroups = C(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.left], (n, t, r2) => {
      var o;
      const a = (o = r2 == null ? void 0 : r2.map((i) => t.find((s) => s.id === i)).filter(Boolean)) != null ? o : [];
      return K(n, a, e, "left");
    }, S(e.options, I)), e.getRightHeaderGroups = C(() => [e.getAllColumns(), e.getVisibleLeafColumns(), e.getState().columnPinning.right], (n, t, r2) => {
      var o;
      const a = (o = r2 == null ? void 0 : r2.map((i) => t.find((s) => s.id === i)).filter(Boolean)) != null ? o : [];
      return K(n, a, e, "right");
    }, S(e.options, I)), e.getFooterGroups = C(() => [e.getHeaderGroups()], (n) => [...n].reverse(), S(e.options, I)), e.getLeftFooterGroups = C(() => [e.getLeftHeaderGroups()], (n) => [...n].reverse(), S(e.options, I)), e.getCenterFooterGroups = C(() => [e.getCenterHeaderGroups()], (n) => [...n].reverse(), S(e.options, I)), e.getRightFooterGroups = C(() => [e.getRightHeaderGroups()], (n) => [...n].reverse(), S(e.options, I)), e.getFlatHeaders = C(() => [e.getHeaderGroups()], (n) => n.map((t) => t.headers).flat(), S(e.options, I)), e.getLeftFlatHeaders = C(() => [e.getLeftHeaderGroups()], (n) => n.map((t) => t.headers).flat(), S(e.options, I)), e.getCenterFlatHeaders = C(() => [e.getCenterHeaderGroups()], (n) => n.map((t) => t.headers).flat(), S(e.options, I)), e.getRightFlatHeaders = C(() => [e.getRightHeaderGroups()], (n) => n.map((t) => t.headers).flat(), S(e.options, I)), e.getCenterLeafHeaders = C(() => [e.getCenterFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), S(e.options, I)), e.getLeftLeafHeaders = C(() => [e.getLeftFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), S(e.options, I)), e.getRightLeafHeaders = C(() => [e.getRightFlatHeaders()], (n) => n.filter((t) => {
      var r2;
      return !((r2 = t.subHeaders) != null && r2.length);
    }), S(e.options, I)), e.getLeafHeaders = C(() => [e.getLeftHeaderGroups(), e.getCenterHeaderGroups(), e.getRightHeaderGroups()], (n, t, r2) => {
      var o, a, i, s, u, d;
      return [...(o = (a = n[0]) == null ? void 0 : a.headers) != null ? o : [], ...(i = (s = t[0]) == null ? void 0 : s.headers) != null ? i : [], ...(u = (d = r2[0]) == null ? void 0 : d.headers) != null ? u : []].map((g) => g.getLeafHeaders()).flat();
    }, S(e.options, I));
  }
};
function K(e, n, t, r2) {
  ...
  const s = function(p, c) {
    c === void 0 && (c = 1), i = Math.max(i, c), p.filter((h) => h.getIsVisible()).forEach((h) => {
      var x;
      (x = h.columns) != null && x.length && s(h.columns, c + 1);
    }, 0);
  };
  s(e);
  let u = [];
  ...
  const m = (p) => p.filter((h) => h.column.getIsVisible()).map((h) => {
    ...
    const _ = Math.min(...v);
    return b = b + _, h.colSpan = x, h.rowSpan = b, {
      colSpan: x,
      rowSpan: b
    };
  });
  return m((o = (a = u[0]) == null ? void 0 : a.headers) != null ? o : []), u;
}
const kt = (e, n, t, r2, o, a, i) => {
  let s = {
    id: n,
    index: r2,
    original: t,
    ...
    getValue: (u) => {
      ...
      if (d != null && d.accessorFn)
        return s._valuesCache[u] = d.accessorFn(s.original, r2), s._valuesCache[u];
    },
    getUniqueValues: (u) => {
      ...
      const d = e.getColumn(u);
      if (d != null && d.accessorFn)
        return d.columnDef.getUniqueValues ? (s._uniqueValuesCache[u] = d.columnDef.getUniqueValues(s.original, r2), s._uniqueValuesCache[u]) : (s._uniqueValuesCache[u] = [s.getValue(u)], s._uniqueValuesCache[u]);
    },
    renderValue: (u) => {
      var d;
      return (d = s.getValue(u)) != null ? d : e.options.renderFallbackValue;
    },
    subRows: [],
    getLeafRows: () => Et(s.subRows, (u) => u.subRows),
    getParentRow: () => s.parentId ? e.getRow(s.parentId, true) : void 0,
    getParentRows: () => {
      let u = [], d = s;
      for (; ; ) {
    ...
    getAllCells: C(() => [e.getAllLeafColumns()], (u) => u.map((d) => Lt(e, s, d, d.id)), S(e.options, "debugRows")),
    _getAllCellsByColumnId: C(() => [s.getAllCells()], (u) => u.reduce((d, g) => (d[g.column.id] = g, d), {}), S(e.options, "debugRows"))
  };
...
We.autoRemove = (e) => E(e);
const Ye = (e, n, t) => !t.some((r2) => {
  var o;
  return !((o = e.getValue(n)) != null && o.includes(r2));
});
Ye.autoRemove = (e) => E(e) || !(e != null && e.length);
const Je = (e, n, t) => t.some((r2) => {
  var o;
  return (o = e.getValue(n)) == null ? void 0 : o.includes(r2);
});
Je.autoRemove = (e) => E(e) || !(e != null && e.length);
const Qe = (e, n, t) => e.getValue(n) === t;
Qe.autoRemove = (e) => E(e);
const Ze = (e, n, t) => e.getValue(n) == t;
Ze.autoRemove = (e) => E(e);
const Ce = (e, n, t) => {
  let [r2, o] = t;
...
const Ot = {
  ...
  createColumn: (e, n) => {
    e.getAutoFilterFn = () => {
      ...
      return typeof r2 == "string" ? L.includesString : typeof r2 == "number" ? L.inNumberRange : typeof r2 == "boolean" || r2 !== null && typeof r2 == "object" ? L.equals : Array.isArray(r2) ? L.arrIncludes : L.weakEquals;
    }, e.getFilterFn = () => {
      var t, r2;
      return J(e.columnDef.filterFn) ? e.columnDef.filterFn : e.columnDef.filterFn === "auto" ? e.getAutoFilterFn() : (
        // @ts-ignore
        (t = (r2 = n.options.filterFns) == null ? void 0 : r2[e.columnDef.filterFn]) != null ? t : L[e.columnDef.filterFn]
      );
    }, e.getCanFilter = () => {
      var t, r2, o;
      ...
      n.setColumnFilters((r2) => {
        const o = e.getFilterFn(), a = r2 == null ? void 0 : r2.find((g) => g.id === e.id), i = k(t, a ? a.value : void 0);
        if (Ie(o, i, e)) {
          var s;
          return (s = r2 == null ? void 0 : r2.filter((g) => g.id !== e.id)) != null ? s : [];
        }
        const u = {
          id: e.id,
          value: i
        ...
        if (a) {
          var d;
          return (d = r2 == null ? void 0 : r2.map((g) => g.id === e.id ? u : g)) != null ? d : [];
        }
  ...
  createTable: (e) => {
    e.setColumnFilters = (n) => {
      const t = e.getAllLeafColumns(), r2 = (o) => {
        var a;
        return (a = k(n, o)) == null ? void 0 : a.filter((i) => {
...
const Tt = (e, n, t) => t.reduce((r2, o) => {
...
}, Kt = (e, n) => Array.from(new Set(n.map((t) => t.getValue(e))).values()), Wt = (e, n) => new Set(n.map((t) => t.getValue(e))).size, Yt = (e, n) => n.length, Z = {
  sum: Tt,
  min: Bt,
  max: jt,
  extent: qt,
  ...
  createColumn: (e, n) => {
    e.toggleGrouping = () => {
      ...
      if (!e)
        throw new Error();
      return J(e.columnDef.aggregationFn) ? e.columnDef.aggregationFn : e.columnDef.aggregationFn === "auto" ? e.getAutoAggregationFn() : (t = (r2 = n.options.aggregationFns) == null ? void 0 : r2[e.columnDef.aggregationFn]) != null ? t : Z[e.columnDef.aggregationFn];
    };
  },
  createTable: (e) => {
...
const Zt = {
  ...
  createColumn: (e, n) => {
    e.getIndex = C((t) => [j(n, t)], (t) => t.findIndex((r2) => r2.id === e.id), S(n.options, "debugColumns")), e.getIsFirstColumn = (t) => {
      var r2;
      return ((r2 = j(n, t)[0]) == null ? void 0 : r2.id) === e.id;
    }, e.getIsLastColumn = (t) => {
      var r2;
      const o = j(n, t);
  ...
  createTable: (e) => {
    ...
    }, e._getOrderColumnsFn = C(() => [e.getState().columnOrder, e.getState().grouping, e.options.groupedColumnMode], (n, t, r2) => (o) => {
      let a = [];
      if (!(n != null && n.length))
        a = o;
      else {
        ...
        for (; s.length && i.length; ) {
          const u = i.shift(), d = s.findIndex((g) => g.id === u);
          d > -1 && a.push(s.splice(d, 1)[0]);
        }
        a = [...a, ...s];
      }
      return Qt(a, t, r2);
    ...
    e.pin = (t) => {
      ...
      n.setColumnPinning((o) => {
        ...
        if (t === "right") {
          var s, u;
          return {
            left: ((s = o == null ? void 0 : o.left) != null ? s : []).filter((m) => !(r2 != null && r2.includes(m))),
            right: [...((u = o == null ? void 0 : o.right) != null ? u : []).filter((m) => !(r2 != null && r2.includes(m))), ...r2]
          };
        }
        if (t === "left") {
          var d, g;
          return {
            left: [...((d = o == null ? void 0 : o.left) != null ? d : []).filter((m) => !(r2 != null && r2.includes(m))), ...r2],
            right: ((g = o == null ? void 0 : o.right) != null ? g : []).filter((m) => !(r2 != null && r2.includes(m)))
          };
        }
        return {
          left: ((a = o == null ? void 0 : o.left) != null ? a : []).filter((m) => !(r2 != null && r2.includes(m))),
          right: ((i = o == null ? void 0 : o.right) != null ? i : []).filter((m) => !(r2 != null && r2.includes(m)))
        };
      });
      ...
      const t = e.getLeafColumns().map((s) => s.id), {
        left: r2,
        right: o
      } = n.getState().columnPinning, a = t.some((s) => r2 == null ? void 0 : r2.includes(s)), i = t.some((s) => o == null ? void 0 : o.includes(s));
  ...
  createRow: (e, n) => {
    e.getCenterVisibleCells = C(() => [e._getAllVisibleCells(), n.getState().columnPinning.left, n.getState().columnPinning.right], (t, r2, o) => {
      const a = [...r2 ?? [], ...o ?? []];
      return t.filter((i) => !a.includes(i.column.id));
    }, S(n.options, "debugRows")), e.getLeftVisibleCells = C(() => [e._getAllVisibleCells(), n.getState().columnPinning.left], (t, r2) => (r2 ?? []).map((a) => t.find((i) => i.column.id === a)).filter(Boolean).map((a) => ({
      ...a,
      position: "left"
    })), S(n.options, "debugRows")), e.getRightVisibleCells = C(() => [e._getAllVisibleCells(), n.getState().columnPinning.right], (t, r2) => (r2 ?? []).map((a) => t.find((i) => i.column.id === a)).filter(Boolean).map((a) => ({
      ...a,
      position: "right"
    })), S(n.options, "debugRows"));
  },
  createTable: (e) => {
    e.setColumnPinning = (n) => e.options.onColumnPinningChange == null ? void 0 : e.options.onColumnPinningChange(n), e.resetColumnPinning = (n) => {
      var t, r2;
      return e.setColumnPinning(n ? ee() : (t = (r2 = e.initialState) == null ? void 0 : r2.columnPinning) != null ? t : ee());
...
const W = {
  ...
  createColumn: (e, n) => {
    e.getSize = () => {
      ...
      return Math.min(Math.max((t = e.columnDef.minSize) != null ? t : W.minSize, (r2 = a ?? e.columnDef.size) != null ? r2 : W.size), (o = e.columnDef.maxSize) != null ? o : W.maxSize);
    }, e.getStart = C((t) => [t, j(n, t), n.getState().columnSizing], (t, r2) => r2.slice(0, e.getIndex(t)).reduce((o, a) => o + a.getSize(), 0), S(n.options, "debugColumns")), e.getAfter = C((t) => [t, j(n, t), n.getState().columnSizing], (t, r2) => r2.slice(e.getIndex(t) + 1).reduce((o, a) => o + a.getSize(), 0), S(n.options, "debugColumns")), e.resetSize = () => {
      n.setColumnSizing((t) => {
        let {
          [e.id]: r2,
          ...o
    ...
    e.getSize = () => {
      ...
      return (a) => {
        ...
        const i = e.getSize(), s = e ? e.getLeafHeaders().map((v) => [v.column.id, v.column.getSize()]) : [[r2.id, r2.getSize()]], u = ne(a) ? Math.round(a.touches[0].clientX) : a.clientX, d = {}, g = (v, _) => {
          ...
          g("end", v), n.setColumnSizingInfo((_) => ({
            ..._,
            isResizingColumn: false,
            startOffset: null,
            startSize: null,
          ...
          upHandler: (v) => {
            c == null ? void 0 : c.removeEventListener("mousemove", h.moveHandler), c == null ? void 0 : c.removeEventListener("mouseup", h.upHandler), p(v.clientX);
          }
        }, x = {
          moveHandler: (v) => (v.cancelable && (v.preventDefault(), v.stopPropagation()), m(v.touches[0].clientX), false),
          upHandler: (v) => {
            var _;
            c == null ? void 0 : c.removeEventListener("touchmove", x.moveHandler), c == null ? void 0 : c.removeEventListener("touchend", x.upHandler), v.cancelable && (v.preventDefault(), v.stopPropagation()), p((_ = v.touches[0]) == null ? void 0 : _.clientX);
          }
        }, b = rn() ? {
          passive: false
        } : false;
        ne(a) ? (c == null ? void 0 : c.addEventListener("touchmove", x.moveHandler, b), c == null ? void 0 : c.addEventListener("touchend", x.upHandler, b)) : (c == null ? void 0 : c.addEventListener("mousemove", h.moveHandler, b), c == null ? void 0 : c.addEventListener("mouseup", h.upHandler, b)), n.setColumnSizingInfo((v) => ({
          ...v,
          startOffset: u,
          startSize: i,
          deltaOffset: 0,
  ...
  createTable: (e) => {
    e.setColumnSizing = (n) => e.options.onColumnSizingChange == null ? void 0 : e.options.onColumnSizingChange(n), e.setColumnSizingInfo = (n) => e.options.onColumnSizingInfoChange == null ? void 0 : e.options.onColumnSizingInfoChange(n), e.resetColumnSizing = (n) => {
      ...
      var t;
      e.setColumnSizingInfo(n ? te() : (t = e.initialState.columnSizingInfo) != null ? t : te());
    }, e.getTotalSize = () => {
      var n, t;
...
const on = {
  ...
  createRow: (e, n) => {
    e._getAllVisibleCells = C(() => [e.getAllCells(), n.getState().columnVisibility], (t) => t.filter((r2) => r2.column.getIsVisible()), S(n.options, "debugRows")), e.getVisibleCells = C(() => [e.getLeftVisibleCells(), e.getCenterVisibleCells(), e.getRightVisibleCells()], (t, r2, o) => [...t, ...r2, ...o], S(n.options, "debugRows"));
  },
  createTable: (e) => {
    const n = (t, r2) => C(() => [r2(), r2().filter((o) => o.getIsVisible()).map((o) => o.id).join("_")], (o) => o.filter((a) => a.getIsVisible == null ? void 0 : a.getIsVisible()), S(e.options, "debugColumns"));
...
const an = {
  ...
  createTable: (e) => {
    e.getGlobalAutoFilterFn = () => L.includesString, e.getGlobalFilterFn = () => {
      ...
      return J(r2) ? r2 : r2 === "auto" ? e.getGlobalAutoFilterFn() : (n = (t = e.options.filterFns) == null ? void 0 : t[r2]) != null ? n : L[r2];
    }, e.setGlobalFilter = (n) => {
  ...
  createRow: (e, n) => {
    e.toggleExpanded = (t) => {
      n.setExpanded((r2) => {
        ...
        let i = {};
        if (r2 === true ? Object.keys(n.getRowModel().rowsById).forEach((s) => {
          i[s] = true;
  ...
  createTable: (e) => {
    ...
    e._autoResetPageIndex = () => {
      ...
      var o;
      e.setPagination(r2 ? re() : (o = e.initialState.pagination) != null ? o : re());
    }, e.setPageIndex = (r2) => {
      e.setPagination((o) => {
        let a = k(r2, o.pageIndex);
      ...
      var o, a;
      e.setPageIndex(r2 ? ue : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageIndex) != null ? o : ue);
    }, e.resetPageSize = (r2) => {
      var o, a;
      e.setPageSize(r2 ? de : (o = (a = e.initialState) == null || (a = a.pagination) == null ? void 0 : a.pageSize) != null ? o : de);
    }, e.setPageSize = (r2) => {
      e.setPagination((o) => {
        const a = Math.max(1, k(r2, o.pageSize)), i = o.pageSize * o.pageIndex, s = Math.floor(i / a);
        return {
          ...o,
          pageIndex: s,
          pageSize: a
      ...
      var a;
      let i = k(r2, (a = e.options.pageCount) != null ? a : -1);
      return typeof i == "number" && (i = Math.max(-1, i)), {
        ...o,
        pageCount: i
      };
    }), e.getPageOptions = C(() => [e.getPageCount()], (r2) => {
      let o = [];
      return r2 && r2 > 0 && (o = [...new Array(r2)].fill(null).map((a, i) => i)), o;
    }, S(e.options, "debugTable")), e.getCanPreviousPage = () => e.getState().pagination.pageIndex > 0, e.getCanNextPage = () => {
      const {
        pageIndex: r2
    ...
    e.pin = (t, r2, o) => {
      ...
      n.setRowPinning((u) => {
        ...
        if (t === "bottom") {
          var m, p;
          return {
            top: ((m = u == null ? void 0 : u.top) != null ? m : []).filter((x) => !(s != null && s.has(x))),
            bottom: [...((p = u == null ? void 0 : u.bottom) != null ? p : []).filter((x) => !(s != null && s.has(x))), ...Array.from(s)]
          };
        }
        if (t === "top") {
          var c, h;
          return {
            top: [...((c = u == null ? void 0 : u.top) != null ? c : []).filter((x) => !(s != null && s.has(x))), ...Array.from(s)],
            bottom: ((h = u == null ? void 0 : u.bottom) != null ? h : []).filter((x) => !(s != null && s.has(x)))
          };
        }
        return {
          top: ((d = u == null ? void 0 : u.top) != null ? d : []).filter((x) => !(s != null && s.has(x))),
          bottom: ((g = u == null ? void 0 : u.bottom) != null ? g : []).filter((x) => !(s != null && s.has(x)))
        };
      });
    }, e.getCanPin = () => {
      var t;
      ...
      const t = [e.id], {
        top: r2,
        bottom: o
      } = n.getState().rowPinning, a = t.some((s) => r2 == null ? void 0 : r2.includes(s)), i = t.some((s) => o == null ? void 0 : o.includes(s));
  ...
  createTable: (e) => {
    e.setRowPinning = (n) => e.options.onRowPinningChange == null ? void 0 : e.options.onRowPinningChange(n), e.resetRowPinning = (n) => {
      var t, r2;
      return e.setRowPinning(n ? oe() : (t = (r2 = e.initialState) == null ? void 0 : r2.rowPinning) != null ? t : oe());
      ...
      return ((o = e.options.keepPinnedRows) == null || o ? (
        ...
        (t ?? []).map((i) => {
          const s = e.getRow(i, true);
          return s.getIsAllParentsExpanded() ? s : null;
        })
      ) : (
        //else get only visible rows that are pinned
        (t ?? []).map((i) => n.find((s) => s.id === i))
      )).filter(Boolean).map((i) => ({
        ...i,
        position: r2
      }));
    }, e.getTopRows = C(() => [e.getRowModel().rows, e.getState().rowPinning.top], (n, t) => e._getPinnedRows(n, t, "top"), S(e.options, "debugRows")), e.getBottomRows = C(() => [e.getRowModel().rows, e.getState().rowPinning.bottom], (n, t) => e._getPinnedRows(n, t, "bottom"), S(e.options, "debugRows")), e.getCenterRows = C(() => [e.getRowModel().rows, e.getState().rowPinning.top, e.getState().rowPinning.bottom], (n, t, r2) => {
  ...
  createTable: (e) => {
    ...
    }), e.getPreSelectedRowModel = () => e.getCoreRowModel(), e.getSelectedRowModel = C(() => [e.getState().rowSelection, e.getCoreRowModel()], (n, t) => Object.keys(n).length ? ae(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, S(e.options, "debugTable")), e.getFilteredSelectedRowModel = C(() => [e.getState().rowSelection, e.getFilteredRowModel()], (n, t) => Object.keys(n).length ? ae(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, S(e.options, "debugTable")), e.getGroupedSelectedRowModel = C(() => [e.getState().rowSelection, e.getSortedRowModel()], (n, t) => Object.keys(n).length ? ae(e, t) : {
      rows: [],
      flatRows: [],
      rowsById: {}
    }, S(e.options, "debugTable")), e.getIsAllRowsSelected = () => {
  ...
  createRow: (e, n) => {
    e.toggleSelected = (t, r2) => {
      ...
      n.setRowSelection((a) => {
        ...
        return ce(s, e.id, t, (i = r2 == null ? void 0 : r2.selectChildren) != null ? i : true, n), s;
      });
    }, e.getIsSelected = () => {
      const {
        rowSelection: t
  ...
  t ? (i.getCanMultiSelect() || Object.keys(e).forEach((s) => delete e[s]), i.getCanSelect() && (e[n] = true)) : delete e[n], r2 && (a = i.subRows) != null && a.length && i.getCanSelectSubRows() && i.subRows.forEach((s) => ce(e, s.id, t, r2, o));
};
function ae(e, n) {
  const t = e.getState().rowSelection, r2 = [], o = {}, a = function(i, s) {
    return i.map((u) => {
      var d;
      const g = Se(u, t);
      if (g && (r2.push(u), o[u.id] = u), (d = u.subRows) != null && d.length && (u = {
        ...u,
        subRows: a(u.subRows)
      }), g)
        return u;
...
function ge(e, n, t) {
  ...
  return e.subRows.forEach((i) => {
    if (!(a && !o) && (i.getCanSelect() && (Se(i, n) ? a = true : o = false), i.subRows && i.subRows.length)) {
      const s = ge(i, n);
      s === "all" ? a = true : (s === "some" && (a = true), o = false);
    }
  }), o ? "all" : a ? "some" : false;
}
const fe = /([0-9]+)/gm, gn = (e, n, t) => et(G(e.getValue(t)).toLowerCase(), G(n.getValue(t)).toLowerCase()), fn = (e, n, t) => et(G(e.getValue(t)), G(n.getValue(t))), pn = (e, n, t) => be(G(e.getValue(t)).toLowerCase(), G(n.getValue(t)).toLowerCase()), mn = (e, n, t) => be(G(e.getValue(t)), G(n.getValue(t))), hn = (e, n, t) => {
  const r2 = e.getValue(t), o = n.getValue(t);
  return r2 > o ? 1 : r2 < o ? -1 : 0;
}, xn = (e, n, t) => be(e.getValue(t), n.getValue(t));
function be(e, n) {
...
function et(e, n) {
  const t = e.split(fe).filter(Boolean), r2 = n.split(fe).filter(Boolean);
  for (; t.length && r2.length; ) {
    const o = t.shift(), a = r2.shift(), i = parseInt(o, 10), s = parseInt(a, 10), u = [i, s].sort();
    if (isNaN(u[0])) {
      if (o > a)
        return 1;
      if (a > o)
    ...
    e.getAutoSortingFn = () => {
      ...
      for (const o of t) {
        ...
        if (Object.prototype.toString.call(a) === "[object Date]")
          return B.datetime;
        if (typeof a == "string" && (r2 = true, a.split(fe).length > 1))
          return B.alphanumeric;
      }
      return r2 ? B.text : B.basic;
    }, e.getAutoSortDir = () => {
      ...
      if (!e)
        throw new Error();
      return J(e.columnDef.sortingFn) ? e.columnDef.sortingFn : e.columnDef.sortingFn === "auto" ? e.getAutoSortingFn() : (t = (r2 = n.options.sortingFns) == null ? void 0 : r2[e.columnDef.sortingFn]) != null ? t : B[e.columnDef.sortingFn];
    }, e.toggleSorting = (t, r2) => {
      const o = e.getNextSortingOrder(), a = typeof t < "u" && t !== null;
      n.setSorting((i) => {
        const s = i == null ? void 0 : i.find((c) => c.id === e.id), u = i == null ? void 0 : i.findIndex((c) => c.id === e.id);
        let d = [], g, m = a ? t : o === "desc";
        if (i != null && i.length && e.getCanMultiSort() && r2 ? s ? g = "toggle" : g = "add" : i != null && i.length && u !== i.length - 1 ? g = "replace" : s ? g = "toggle" : g = "replace", g === "toggle" && (a || o || (g = "remove")), g === "add") {
          var p;
          d = [...i, {
            id: e.id,
            desc: m
          }], d.splice(0, d.length - ((p = n.options.maxMultiSortColCount) != null ? p : Number.MAX_SAFE_INTEGER));
        } else g === "toggle" ? d = i.map((c) => c.id === e.id ? {
          ...c,
          desc: m
        } : c) : g === "remove" ? d = i.filter((c) => c.id !== e.id) : d = [{
          id: e.id,
          desc: m
        }];
        return d;
...
function Cn(e) {
  var n, t;
  const r2 = [...wn, ...(n = e._features) != null ? n : []];
  let o = {
    _features: r2
  };
  const a = o._features.reduce((p, c) => Object.assign(p, c.getDefaultOptions == null ? void 0 : c.getDefaultOptions(o)), {}), i = (p) => o.options.mergeOptions ? o.options.mergeOptions(a, p) : {
    ...a,
    ...p
  };
  let u = {
  ...
  const m = {
    ...
    initialState: u,
    _queue: (p) => {
      d.push(p), g || (g = true, Promise.resolve().then(() => {
        for (; d.length; )
          d.shift()();
        g = false;
      }).catch((c) => setTimeout(() => {
    ...
    _getRowId: (p, c, h) => {
      var x;
      return (x = o.options.getRowId == null ? void 0 : o.options.getRowId(p, c, h)) != null ? x : `${h ? [h.id, c].join(".") : c}`;
    },
    ...
    getRow: (p, c) => {
      let h = (c ? o.getPrePaginationRowModel() : o.getRowModel()).rowsById[p];
      if (!h && (h = o.getCoreRowModel().rowsById[p], !h))
        throw new Error();
      return h;
    },
    _getDefaultColumnDef: C(() => [o.options.defaultColumn], (p) => {
      var c;
      return p = (c = p) != null ? c : {}, {
        header: (h) => {
    ...
    getAllFlatColumns: C(() => [o.getAllColumns()], (p) => p.flatMap((c) => c.getFlatColumns()), S(e, "debugColumns")),
    _getAllFlatColumnsById: C(() => [o.getAllFlatColumns()], (p) => p.reduce((c, h) => (c[h.id] = h, c), {}), S(e, "debugColumns")),
    getAllLeafColumns: C(() => [o.getAllColumns(), o._getOrderColumnsFn()], (p, c) => {
      let h = p.flatMap((x) => x.getLeafColumns());
      return c(h);
    }, S(e, "debugColumns")),
    getColumn: (p) => {
  ...
  return (e) => C(() => [e.options.data], (n) => {
    const t = {
      ...
      for (let d = 0; d < o.length; d++) {
        const g = kt(e, e._getRowId(o[d], d, i), o[d], d, a, void 0, i == null ? void 0 : i.id);
        if (t.flatRows.push(g), t.rowsById[g.id] = g, s.push(g), e.options.getSubRows) {
          var u;
          g.originalSubRows = e.options.getSubRows(o[d], d), (u = g.originalSubRows) != null && u.length && (g.subRows = r2(g.originalSubRows, a + 1, g));
        }
      }
      return s;
    };
...
function _r({
  ...
  return ((_a = m.getRowModel().rows) == null ? void 0 : _a.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: f("overflow-hidden rounded-md border", r2), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Fe, { className: o, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx($e, { className: "bg-trax-neutral-10", children: m.getHeaderGroups().map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(Q, { className: g == null ? void 0 : g.headerRow, children: c.headers.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(Pe, { className: g == null ? void 0 : g.headerCell, children: h.isPlaceholder ? null : ie(
      h.column.columnDef.header,
      h.getContext()
    ) }, h.id)) }, c.id)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Vt, { children: m.getRowModel().rows.map((c) => {
      const h = a === c.id;
      return /* @__PURE__ */ jsxRuntimeExports.jsx(
        Q,
        {
          ...
          children: c.getVisibleCells().map((x) => /* @__PURE__ */ jsxRuntimeExports.jsx(Dt, { className: g == null ? void 0 : g.bodyCell, children: ie(x.column.columnDef.cell, {
            ...x.getContext(),
            isEditing: h,
            onEdit: () => i == null ? void 0 : i(c),
            onSave: () => s == null ? void 0 : s(c),
            onCancel: u
          }) }, x.id))
        },
        c.id
  ...
  ] }) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: f("overflow-hidden rounded-md border", r2), children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Fe, { className: o, children: /* @__PURE__ */ jsxRuntimeExports.jsx($e, { className: "bg-trax-neutral-10", children: m.getHeaderGroups().map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(Q, { className: g == null ? void 0 : g.headerRow, children: c.headers.map((h) => /* @__PURE__ */ jsxRuntimeExports.jsx(Pe, { className: g == null ? void 0 : g.headerCell, children: h.isPlaceholder ? null : ie(
      h.column.columnDef.header,
      h.getContext()
    ) }, h.id)) }, c.id)) }) }),
        ...
        i && s && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "span",
          {
            className: f(
              ...
              H ? "text-trax-red-500" : "text-trax-grey-500"
            ),
            children: [
              V,
              "/",
  ...
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: f("flex flex-col gap-1 w-full", d), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Oe, { value: P, onValueChange: _, disabled: u, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            xe,
            {
              ref: b,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ve, { children: a.map((N) => /* @__PURE__ */ jsxRuntimeExports.jsx(we, { value: N.value, children: N.label }, N.value)) })
        ] })
      ] }),
...
const $n = R.forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(_t, { open: P, onOpenChange: N, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Nt, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          U,
          {
            ref: _,
            id: y,
            ...
            ...v,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: f(
                "text-left",
                D ? "text-trax-neutral-900" : "text-trax-grey-500"
              ), children: D ? format(D, "yyyy-MM-dd") : a }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4 text-trax-grey-500" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Ft, { className: "w-auto p-0 bg-white", align: "start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Mt,
          {
            mode: "single",
            selected: D,
            onSelect: V,
            disabled: (A) => !!(m && A < m || p && A > p),
            captionLayout: "label",
            fromYear: (m == null ? void 0 : m.getFullYear()) || 1900,
...
const Mn = R.forwardRef(
  ({
    ...
    const [d, g] = R.useState(false), m = R.useRef(null), p = (v) => {
      ...
      _ && _.length > 0 && (n == null ? void 0 : n(_));
    }, x = () => {
      !i && m.current && m.current.click();
    }, b = (v) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        className: f(
          ...
          d && "border-trax-blue-600 bg-trax-blue-600/5",
...
const tt = R.forwardRef(
  ({
    ...
    "div",
    {
      ...
      ...u,
      children: [
        t && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: f(
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: f(
            "transition-all duration-200 ease-in-out overflow-hidden",
            u ? "max-h-0 opacity-0" : "max-h-none opacity-100"
...
const Vn = R.forwardRef(
  ({
    ...
    onAddAllocation: i,
    onRemoveAllocation: s,
    ...u
  }, d) => {
    const g = t.reduce((m, p) => m + p.percentage, 0);
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ref: d,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-center f-full gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(qe, { value: g || 3, className: "h-2", indicatorClassName: "bg-trax-neutral-100" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm font-medium text-trax-neutral-100", children: [
              g,
              "%"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-1.5", children: t.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between bg-grey-50 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pt, { variant: "category", children: m.name }) }, m.id)) }),
...
Vn.displayName = "CostAllocation";
function Ve(e, n, t = "narrow") {
  var _a;
  ...
  ({
    ...
    const v = m || `currency-input-${Math.random().toString(36).substring(2, 11)}`, _ = t ?? (n ? Ve(n, r2, i) : void 0), y = o ?? (_ ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground text-xs", "aria-hidden": true, children: _ }) : null), P = a ?? (p && c.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-2 top-1/2 -translate-y-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Oe,
      {
        value: n,
        onValueChange: (N) => {
          const V = c.find((H) => H.code === N);
          V && h && h(V);
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(xe, { className: "h-6 border-0 shadow-none bg-transparent hover:bg-gray-50 focus:ring-0 focus:ring-offset-0 px-2 py-1 text-xs font-medium text-trax-grey-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Te, { children: n }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ve, { children: c.map((N) => {
            const V = N.symbol ?? Ve(N.code, N.locale || r2, i);
            return /* @__PURE__ */ jsxRuntimeExports.jsx(we, { value: N.code, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: V }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: N.code })
            ] }) }, N.code);
          }) })
        ]
      }
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1 w-full", children: [
      s && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Label$2,
          {
            htmlFor: v,
        ...
        u && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-trax-red-400 leading-0", children: "*" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          he,
      ...
      d && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-nowrap justify-start items-center gap-0.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "text-trax-red-500 size-3.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-trax-red-500 font-normal", children: d })
      ] }),
      g && !d && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-trax-grey-600", children: g })
    ] });
  }
);
...
const zn = R.forwardRef(
  ({
    ...
    {
      ref: u,
      className: f("inline-flex gap-[1px]", s),
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          U,
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(wt, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Ct, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            U,
            {
              disabled: i,
              variant: o,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(St, { align: "end", className: "min-w-[200px]", children: t.map((d, g) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            bt,
            {
              onClick: d.onClick,
              className: "flex items-center gap-2",
              children: [
                d.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center justify-center [&>svg]:size-4", children: d.icon }),
                d.label
              ]
            },
            g
...
Ln.displayName = Content$1.displayName;
const Hn = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
Hn.displayName = "CustomDialogHeader";
const An = ({
  className: e,
  ...n
}) => /* @__PURE__ */ jsxRuntimeExports.jsx(
...
Gn.displayName = Description.displayName;
/**
