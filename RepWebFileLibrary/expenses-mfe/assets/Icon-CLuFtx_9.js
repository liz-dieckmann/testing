...
const loadIcon = async (name) => {
  ...
  const loadPromise = (async () => {
    try {
      const svgContent = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../../assets/icons/delete.svg": () => __vitePreload(() => import("./delete-CIxmXS6N.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/error-outline.svg": () => __vitePreload(() => import("./error-outline-DfZXRXSN.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/icon-file-img.svg": () => __vitePreload(() => import("./icon-file-img-BGzKl0aA.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/icon-file-pdf.svg": () => __vitePreload(() => import("./icon-file-pdf-Ci1K-nc7.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/open-in-new.svg": () => __vitePreload(() => import("./open-in-new-tlr79Hkw.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/pdf-file-green-check.svg": () => __vitePreload(() => import("./pdf-file-green-check-DMKJZdAQ.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/receipt.svg": () => __vitePreload(() => import("./receipt-BW5bPfyM.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/receipt_long.svg": () => __vitePreload(() => import("./receipt_long-7Dnx6u7m.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/summarize.svg": () => __vitePreload(() => import("./summarize-f6NqYbOk.js"), true ? [] : void 0, import.meta.url), "../../assets/icons/text-line-unknown.svg": () => __vitePreload(() => import("./text-line-unknown-T_6c8lUf.js"), true ? [] : void 0, import.meta.url) }), `../../assets/icons/${name}.svg`, 5);
