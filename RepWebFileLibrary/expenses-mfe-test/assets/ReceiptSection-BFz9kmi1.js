...
import { U as ReceiptUpload } from "./SupportingFilesFormSection-EAVGYwUs.js";
function AffidavitContent({
  control,
  disabled = false
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-full flex-1 flex flex-col min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Ea, { className: "w-full max-h-full bg-yellow-50 border border-yellow-200 p-3 flex flex-col overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-2 h-full overflow-y-auto", children: [
...
function ReceiptSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Ea, { className: "h-full", children: [
